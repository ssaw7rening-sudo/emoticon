...
export function bulkSaveLayoutPlugin() {
  return {
    ...
    transform(code, id) {
      ...
      if (out.includes('onClick={downloadZip}')) {
        throw new Error('[bulk-save-layout] ZIP button still connected to UI');
      }
      ...
      if (out.includes('PNG · ZIP')) throw new Error('[bulk-save-layout] ZIP wording still visible');
