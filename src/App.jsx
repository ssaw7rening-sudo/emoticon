...
const THEMES_KO = {
  ...
  '럭키비키/초긍정 ①': ['오히려 좋아', '완전 럭키비키잖아', '난 역시 행운아', '다 잘될 거야', '긍정 파워 충전', '행운의 여신 강림', '기회는 지금이야', '긍정 마인드셋', '오늘의 운세 대박', '웃으면 복이 와요', '별거 아니야 툭툭', '낭만 가득한 하루', '감사한 마음', '내일은 더 좋을 거야', '행복 회로 가동'],
...
const THEMES_EN = {
  ...
  'Lucky Vicky/Ultra Positive ①': ['Even better this way', 'Totally Lucky Vicky!', 'Born lucky after all', 'Everything will be fine', 'Positive energy recharged', 'Lady luck is on my side', 'Now is the chance', 'Positive mindset', 'Super lucky horoscope today', 'Smile and luck follows', 'No big deal, shake it off', 'Romantic day full of vibes', 'Grateful heart', 'Tomorrow will be even better', 'Firing up happiness circuits'],
...
const THEMES_JA = {
  ...
  '超ポジティブ・幸運 ①': ['むしろラッキー！', '完全にラッキービッキー！', 'やっぱり持ってる！', '全部うまくいくよ', 'ポジティブパワー充電', '幸運の女神降臨', 'チャンスは今だ', 'ポジティブ思考', '今日の運勢最高', '笑う門には福来る', '大丈夫、へっちゃら', 'ロマンチックな一日', '感謝の気持ち', '明日はもっと良くなる', '幸せ回路全開'],
...
const THEMES_ZH = {
  ...
  '超幸运・积极满满 ①': ['反而更好啦！', '完全是转角遇到爱！', '我果然是幸运星', '一切都会好起来的', '正能量电量满格', '幸运女神降临', '机会就在眼前', '积极阳光心态', '今日运势大吉', '笑口常开好运自然来', '拍拍灰尘没事啦', '充满浪漫的一天', '常怀感恩的心', '明天一定会更好', '幸福脑洞大开'],
