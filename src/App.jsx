...
const THEMES_KO = {
  ...
  '어린이/유치원 ①': ['아빠 힘내세요', '나 잘했죠?', '사주세요!', '간식 시간!', '내일 또 만나요!', '낮잠 싫어~', '삐졌어요 (흥!)', '저요!', '소풍 가요!', '다 먹었어요!', '가기 싫어요~', '내가 할래요!', '놀이터 가자', '엄마 사랑해요', '졸려요~'],
...
4. 텍스트 상자(박스), 말풍선, 괄호 (), 대괄호 [], 따옴표 "", 스티커 번호는 절대로 넣지 마세요.`
        ...
        return `[목표]
동일한 캐릭터가 등장하는 고품질 2D 메신저 스티커 (카카오톡 / 라인 스타일) 1장을 그려주세요. 정사각형 캔버스, 고해상도.
