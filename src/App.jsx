...
const ThemePickerModal = React.lazy(() => import("./components/ThemePickerModal.jsx"));
...
const THEMES_KO = {
  ...
  '럭키비키/초긍정 ①': ['오히려 좋아!', '완전 럭키잖아', '럭키비키 니키', '난 역시 행운아', '다 잘될 거야', '행운 충전 완료', '오예 럭키!', '기회는 지금!', '행복 회로 가동', '오늘 운세 대박', '웃으면 복이 와', '오히려 이득!', '꽃길 직행 탑승', '낭만 합격!', '내일은 더 대박'],
  '럭키비키/초긍정 ②': ['오히려 개이득', '될 놈은 된다', '내 인생 레전드', '초긍정 파워!', '하늘도 내 편', '별거 아니야 훗', '마음먹기 나름', '우주가 날 도와', '럭키력 상승!', '긍정 빔 발사!', '행복은 셀프', '탈룰라 대성공', '걱정은 털어내', '다 하늘의 뜻', '내일도 럭키!'],
  ...
  'SNS/도파민 중독 ①': ['도파민 충전 중', '쇼츠 보다 밤샘', '알고리즘의 간택', '시간 순삭 실화냐', '좋아요 꾹 눌러줘', '스크린타임 경고', '이 릴스 봐봐 ㅋ', '폰 내려놔야지...', '댓글 정독 중', '도파민 폭발!', '새로고침 무한반복', '인스타 각 떴다', '알림 떴다 설렘', '공유 링크 보냄', '폰과 물아일체'],
  'SNS/도파민 중독 ②': ['도파민 디톡스 시급', '5분만 더 볼게...', '침대 위 폰 감옥', '현생 살러 갑니다', '얼굴에 폰 떨굼', '눈이 침침하다...', '알고리즘 소름!', '배터리 1퍼 버팀', '인스타 스토리 구경', '새벽 감성 돋네', '폰 중독 인정', '좋아요 실수 식은땀', 'DM 확인했어?', '와이파이 찾아 헤맴', '이제 진짜 자야지'],
  ...
  'K-직장인 생존기 ①': ['칼답 넵!', '네... (영혼 가출)', '간식 서랍 털기', '금융치료 시급', '퇴근각 재는 중', '넵 알겠습니다!', '카드값이 지배함', '회의 지옥...', '카페인 수혈 중', '시말서 각인가', '법카 가자!', '구조대 급구...', '퇴근 셔터 내림', '주말만 봐요', '내일 연차 씀!'],
  'K-직장인 생존기 ②': ['넵 병 걸림', '통장을 스침', '아아 긴급 수혈', '보고서 반려...', '이게 최선입니다', '읽씹인가요...?', '회의 탈출 시도', '화장실 피신 중', '퇴근 발걸음 슝', '오늘 저녁 고기?', '모니터 멍...', '연차 핑계 탐색', '집에 갈래 ㅠㅠ', '통장 보고 참음', '오늘도 생존!'],
  ...
  '당근/중고거래 ①': ['혹시 당근이세요?', '쿨거래 감사해요!', '네고 정중히 사절', '매너온도 99도!', '직거래 약속 잡기', '택배 접수 완료!', '송장 번호 보냄', '아직 판매 중?', '상태 아주 좋아요', '풀박스 보관 중', '거래 장소 도착!', '계좌 입금 완료', '따뜻한 후기 남김', '예약 걸어둘게요', '안전하게 포장함'],
  '당근/중고거래 ②': ['잠수 타지 마세요', '약속시간 5분 전', '무리한 네고 사절', '새것 같은 중고템', '당근 알림 울렸다!', '문고리 거래할게요', '반값택배 가능해요', '빠른 거래 환영!', '구매 영수증 인증', '불발 시 연락 요망', '돈 봉투 건네기', '득템 성공 만세!', '비매너 신고 완료', '미개봉 새 제품임', '좋은 분 만나 다행'],
  ...
  '러닝/마라톤 ①': ['오늘 러닝 끝!', '5km 완주!', '페이스 유지!', '새 신발 개시!', '심장 터짐!', '러닝 크루 모여', '아침 조깅 상쾌', '발목 빙글빙글', '물 원샷 꿀꺽', '최고 기록 경신!', '우중런 감성', '숨 고르는 중', '10km 도전!', '땀 뻘뻘 개운!', '내일도 뛴다!'],
  '러닝/마라톤 ②': ['신발 끈 꽉!', '심박수 정상', '오늘 코스 최고', '러너스 하이!', '나이트런 출발', '완주 메달 찰칵', '처지지 말자!', '이온음료 원샷', '폼롤러 비명', '달릴 때 찐행복', '새벽 공기 질주', '탄수화물 보충', '물집도 훈장!', '러닝 중독자', '내일 새벽 예약'],
  ...
  '홈카페/디저트러버 ①': ['달달구리 충전!', '빵지순례 파티원', '디저트 필수 코스', '소금빵 갓 구움!', '혈중 당도 급락...', '두바이 초콜릿 겟!', '1일 1아아 필수', '홈카페 힐링 타임', '원두 향기 솔솔~', '치즈 케이크 냠냠', '구움과자 냄새 유혹', '얼죽아 협회 회원', '따뜻한 라떼 아트', '달콤한 소확행 완료', '오늘의 당 보충 끝!'],
  '홈카페/디저트러버 ②': ['커피 수혈 시급함', '크룽지 바삭 소리', '빵 냄새에 홀렸어', '에스프레소 투샷!', '생크림 듬뿍 얹음', '버터 풍미 폭발!', '마카롱 쫀득쫀득', '베이글에 크림치즈', '디카페인으로 변경', '핸드드립 추출 중', '디저트 천국 도착', '겉바속촉의 정석!', '달콤쌉싸름 힐링', '다이어트는 내일!', '내일 또 카페 가자'],
  '성수동/팝업스토어 ①': ['오픈런 대기!', '웨이팅 100번', '굿즈 품절 ㅠㅠ', '한정판 겟!', '인생샷 건짐!', '감성 카페 도착', '핫플 도장 깨기', '지갑 활짝 열림', '포토존 찰칵!', '내 번호 호출!', '풀세트 질렀다', '사람 대폭발!', '성수동 투어 중', '카드 슬래시!', '다음 팝업 고고'],
  '성수동/팝업스토어 ②': ['웨이팅 성공!', '쇼룸 포토존', '영수증 기절각', '한정판 사수!', '핫플 정복 완료', '스티커 득템!', '입장 3초 전!', '친구랑 투샷 찰칵', '부스 체험 완료', '쇼핑백 한가득', '감성 천국 인정', '기다린 보람!', '골목길 산책', '다음 시즌도 필참', '오늘도 핫플러'],
...
const THEMES_EN = {
  ...
  'Lucky Vicky/Ultra Positive ①': ['Even better now!', 'Totally Lucky Vicky', 'Born lucky~', 'All will be fine', 'Lucky recharge', 'Lady luck is here', 'Now is the time!', 'Mindset is key', 'Happiness mode ON', 'Super lucky day', 'Smile brings luck', 'Win-win for me!', 'VIP on flower road', 'Romantic pass!', 'Tomorrow bigger!'],
  'Lucky Vicky/Ultra Positive ②': ['Huge profit!', 'Born to succeed', 'Legendary life', 'Ultra positive!', 'Heavens on my side', 'No big deal haha', 'All in the mind', 'Universe helps me', 'Lucky power UP!', 'Positive beam!', 'Self happiness', 'Saved the day!', 'Shake off worry', 'Destiny at work', 'Lucky tomorrow!'],
  ...
  'Social Media/Dopamine ①': ['Dopamine recharge', 'Up all night on Shorts', 'Chosen by algorithm', 'Time flew so fast', 'Smash that like button', 'Screen time alert', 'Watch this reel lol', 'Gotta put phone down...', 'Reading every comment', 'Dopamine explosion!', 'Infinite refresh loop', 'Instagram worthy!', 'Notification hype', 'Sent a share link', 'One with my phone'],
  'Social Media/Dopamine ②': ['Dopamine detox STAT', 'Just 5 more minutes...', 'Phone prison on bed', 'Going back to reality', 'Dropped phone on face', 'Blurry tired eyes...', 'Algorithm is scary!', 'Surviving on 1% battery', 'Stalking IG stories', 'Late night mood', 'Admitting phone addict', 'Accidental like sweat', 'Did you check DM?', 'Searching for Wi-Fi', 'Really sleeping now'],
  ...
  'Office Survival Mode ①': ['Instant got it!', 'Yes... (drained)', 'Snack drawer raid', 'Paycheck therapy', 'Timing clock-out', 'Yes sir, noted!', 'Bills took over', 'Meeting hell...', 'Caffeine reload', 'Write-up incoming?', 'On company card!', 'Rescue team SOS', 'Work shutter closed', 'Living for Friday', 'Taking PTO!'],
  'Office Survival Mode ②': ['Got-it sickness', 'Account bypassed', 'Iced coffee STAT', 'Report rejected...', 'My best effort', 'Left on read...?', 'Meeting escape', 'Restroom hiding', 'Flying steps home', 'Steak tonight?', 'Monitor blank stare', 'PTO excuse search', 'Wanna go home ㅠㅠ', 'Account inner peace', 'Survived today!'],
  ...
  'Secondhand/Local Market ①': ['Are you the buyer?', 'Thanks for cool deal!', 'Respectfully no nego', 'Manner score 99°C!', 'Setting meetup time', 'Parcel shipped out!', 'Sent tracking number', 'Still available?', 'Condition is like new', 'Full box included', 'Arrived at meetup spot!', 'Payment transferred', 'Left a warm review', 'Holding item for you', 'Packed safe and sound'],
  'Secondhand/Local Market ②': ['Please do not ghost', '5 mins before meetup', 'No lowball offers', 'Pristine used item', 'Trade alert chime!', 'Leave at doorstep trade', 'Discount shipping ready', 'Fast deals preferred!', 'Original receipt proof', 'Next in line if cancel', 'Handing cash envelope', 'Snagged a huge bargain!', 'Reported bad manners', 'Unopened brand new', 'Glad to meet nice buyer'],
  ...
  'Running/Marathon Crew ①': ['Run done today!', 'Finished 5k!', 'Keep the pace!', 'New shoes unboxed!', 'Heart pumping!', 'Run crew assemble', 'Morning jog fresh', 'Ankle roll prep', 'Chugging water', 'New PB record!', 'Rainy run vibes', 'Catching breath', 'Aiming for 10k!', 'Sweat so clean!', 'Running tomorrow!'],
  'Running/Marathon Crew ②': ['Laces tied tight!', 'Heart rate good', 'Best course ever', 'Runner\'s High!', 'Night run launch', 'Medal selfie snap', 'Stay on pace!', 'Electrolyte chug', 'Foam roller scream', 'Pure running joy', 'Dawn air sprint', 'Carb load fuel', 'Blister is glory!', 'Running addict', 'Early run booked'],
  ...
  'Home Cafe/Dessert Lover ①': ['Sweet sugar reload!', 'Bakery tour squad', 'Mandatory dessert course', 'Fresh baked salt bread!', 'Blood sugar dropping...', 'Secured Dubai chocolate!', 'Mandatory daily iced coffee', 'Home cafe healing vibe', 'Coffee bean aroma~', 'Cheesecake nom nom', 'Fresh pastry temptation', 'Ice cold drink loyalist', 'Warm cozy latte art', 'Sweet little happiness', 'Sugar intake complete!'],
  'Home Cafe/Dessert Lover ②': ['Urgent coffee transfusion', 'Crunchy Croongji sound', 'Hypnotized by bread scent', 'Double espresso shot!', 'Whipped cream overload', 'Rich butter explosion!', 'Chewy sweet macarons', 'Bagel with cream cheese', 'Switch to decaf please', 'Brewing pour over drip', 'Arrived at dessert heaven', 'Crispy outside soft inside!', 'Bittersweet healing', 'Diet starts tomorrow!', 'Cafe again tomorrow!'],
  'Pop-up Store/Hot Place ①': ['Open run queue!', 'Waiting number 100', 'Merch sold out ㅠㅠ', 'Got limited item!', 'Life photo saved!', 'Aesthetic cafe', 'Hot spot conquered', 'Wallet wide open', 'Photo zone snap!', 'My number called!', 'Bought full set', 'Crowd explosion!', 'Seongsu tour now', 'Card swipe slash!', 'Next pop-up go'],
  'Pop-up Store/Hot Place ②': ['Waitlist success!', 'Showroom spot', 'Receipt shocker', 'Secured merch!', 'Conquered spot', 'Stickers scored!', '3s before entry!', 'Bestie selfie snap', 'Booth quest done', 'Hands full of bags', 'Aesthetic heaven', 'Worth the wait!', 'Alley stroll walk', 'Next season too!', 'Certified trendsetter'],
...
const THEMES_JA = {
  ...
  '超ポジティブ・幸運 ①': ['むしろ最高！', '完全ラッキー！', 'やっぱり持ってる', '全部うまくいく', '幸運チャージ完了', '女神降臨中！', '今がチャンス！', '気持ち次第！', '幸せ回路全開', '今日の運勢最高', '笑う門に福来る', '完全に得した！', '花道へ直行！', 'ロマン合格！', '明日はもっと大吉'],
  '超ポジティブ・幸運 ②': ['むしろ大得！', '勝つべくして勝つ', '我が人生レジェンド', '超ポジティブ！', '天も味方してる', '大したことないサ', '気の持ちよう！', '宇宙が味方！', 'ラッキー度急上昇', 'ポジティブ光線！', '幸せは自分次第', '大逆転セーフ！', '悩み吹き飛ばせ', 'すべて運命！', '明日もラッキー！'],
  ...
  'SNS・ドーパミン中毒 ①': ['ドーパミン充電中', 'ショート動画で徹夜', 'アルゴリズムの選別', '時間溶けたマジで', 'いいね押してね！', 'スクリーンタイム警告', 'このリール見てw', 'スマホ置かなきゃ…', 'コメント欄熟読中', 'ドーパミン大爆発！', '無限リロード中', 'インスタ映え確定', '通知キター！', '共有リンク送ったよ', 'スマホと一心同体'],
  'SNS・ドーパミン中毒 ②': ['デジタルデトックス急務', 'あと5分だけ…', 'ベッドでスマホの檻', '現実世界に戻ります', '顔面にスマホ落下', '目がかすんできた…', 'アルゴリズム鳥肌！', 'バッテリー1％で粘る', 'ストーリー巡回中', '深夜のエモい気分', 'スマホ中毒認めます', '誤いいねで冷や汗', 'DM見た？', 'Wi-Fi難民中', '本当に寝ます！'],
  ...
  'リアル会社員・サバイバル ①': ['即答了解！', 'はい…（抜け殻）', 'お菓子引き出し捜索', '金銭治療が急務', '退勤チャンス狙い', '了解いたしました', 'カード明細に絶句', '会議地獄…', 'カフェイン点滴中', '始末書フラグ？', '経費で落とそう', '救助隊SOS…', '退勤シャッターガラガラ', '週末だけ見てる', '明日有休です！'],
  'リアル会社員・サバイバル ②': ['了解病発症', '口座を一瞬通過', 'アイスコーヒー命', '企画差し戻し…', 'これが限界です', '既読スルーかな？', '会議脱出作戦', 'トイレに避難中', '退勤ダッシュ！', '今夜はお肉？', '画面見てボーッ', '有休理由探し中', '帰りたい（涙）', '通帳見て耐える', '今日も生存！'],
  ...
  'フリマ・中古取引 ①': ['フリマの方ですか？', '即決ありがとう！', '値下げ交渉お断り', '評価オール星5つ！', '待ち合わせ決定', '発送手続き完了！', '追跡番号送りました', 'まだ購入可能ですか？', '状態とても良好です', '箱・付属品完備', '取引場所に到着！', 'お振込み完了です', '良い評価つけました', 'お取り置きしますね', '丁寧に梱包しました'],
  'フリマ・中古取引 ②': ['ドタキャン禁止です', '約束の5分前到着', '大幅な値下げ不可', '新品同様の美品です', '取引通知ピコーン！', '置き配取引しますね', '安い配送方法可能', '早い者勝ち大歓迎！', '購入レシート添付', 'キャンセル待ち希望', '現金手渡しでお会計', '掘り出し物ゲット！', '迷惑ユーザー通報', '未開封の新品です', '良い方に巡り会えた'],
  ...
  'ランニング・マラソン ①': ['今日のラン終了！', '5km完走！', 'ペース維持！', '新シューズ解禁！', '心臓バクバク！', 'ラン仲間集まれ', '朝ジョグ爽快！', '足首ぐるぐる', '水ごくごく補給', '自己ベスト更新！', '雨ランエモい', '息を整え中', '10km挑戦！', '汗かいて快感！', '明日も走るぞ！'],
  'ランニング・マラソン ②': ['靴ひもキュッ！', '心拍数正常', '今日コース最高', 'ランナーズハイ！', '夜ラン出発！', '完走メダルパシャリ', 'ペース落とすな！', 'スポドリ一気！', 'フォームローラー悲鳴', '走ると超幸せ', '朝の空気疾走', '炭水化物チャージ', 'マメも勲章！', 'ランニング中毒', '明日早朝予約！'],
  ...
  'おうちカフェ・スイーツ ①': ['糖分チャージ完了！', 'パン屋さん巡り仲間', 'デザート必須コース', '焼きたて塩パン最高！', '血糖値急降下中…', 'ドバイチョコゲット！', '1日1アイスコーヒー', 'おうちカフェで癒やし', '珈琲豆のいい香り〜', 'チーズケーキもぐもぐ', '焼き菓子の香ばしい匂い', '年中アイスコーヒー派', '温かいラテアート', '甘い小さな幸せ完了', '今日の糖分補給終了！'],
  'おうちカフェ・スイーツ ②': ['緊急カフェイン補給', 'クルンジのサクサク音', 'パンの香りに釣られた', 'エスプレッソ2ショット', '生クリームたっぷり', 'バター風味大爆発！', 'もっちりマカロン', 'ベーグルにクリームチーズ', 'ディカフェに変更で', 'ハンドドリップ抽出中', 'スイーツ天国に到着', '外サク中モチの極み！', 'ほろ苦甘い至福の時間', 'ダイエットは明日から！', '明日もカフェ行こうね'],
  'ポップアップ・ホットプレイス ①': ['開店ダッシュ！', '待ち番号100番', 'グッズ完売（涙）', '限定品ゲット！', '映え写真回収！', 'おしゃれカフェ着', '人気スポット制覇', '財布ガバガバ', '撮影スポット！', '番号呼ばれた！', 'フルコンプした', '人多すぎ注意！', '聖水ツアー中', 'カード一括払い！', '次ポップアップへ'],
  'ポップアップ・ホットプレイス ②': ['順番待ち大成功！', 'ショールームへ', 'レシートで気絶', '限定品死守！', '人気地制覇完了', 'ステッカー獲得！', '入場3秒前！', '友達とツーショット', '体験ブース制覇', '袋いっぱい大満足', 'エモい空間認定', '待った甲斐あり！', '路地裏お散歩', '次回も絶対参加', '今日も流行ハンター'],
...
const THEMES_ZH = {
  ...
  '超幸运・积极满满 ①': ['反而更好！', '完全超幸运', '运气爆棚啦', '一切都会好', '电量满格充电', '幸运女神驾到', '机会就是现在', '心态最重要', '快乐回路启动', '今日运势大吉', '笑口常开福到', '反而更划算！', '直奔锦绣花路', '浪漫满分！', '明天更精彩'],
  '超幸运・积极满满 ②': ['反而大赚！', '天选之子就是我', '人生高光时刻', '超正能量！', '老天都在帮我', '小事一桩啦', '看怎么想咯', '宇宙在偏爱我', '好运值狂飙！', '发射正向光波', '快乐掌握自己', '反向操作大胜', '甩掉所有焦虑', '都是最好安排', '明天也超幸运！'],
  ...
  '社交网络・多巴胺成瘾 ①': ['多巴胺疯狂充电中', '刷短视频又通宵了', '被算法大数据选中', '时间瞬间蒸发无语', '给个点赞关注嘛！', '屏幕使用时间警告', '快看这个神仙视频', '真的该放下手机了', '在评论区住下了', '多巴胺彻底大爆发', '疯狂无休止刷新', '出片率百分百好绝', '来特别关注通知了', '分享链接发给你了', '已和手机融为一体'],
  '社交网络・多巴胺成瘾 ②': ['急需多巴胺大断食', '再看最后五分钟…', '被困在床上手机牢', '回现实世界搬砖了', '手机直直砸在脸上', '眼睛开始酸涩模糊', '算法太懂我好吓人', '电量百分之一硬撑', '暗戳戳刷朋友圈中', '深夜情绪暗涌上头', '承认自己网瘾少年', '手滑点赞一身冷汗', '看私信消息了吗？', '到处寻找救命网速', '这次真的要睡觉了'],
  ...
  '打工人求生日常 ①': ['秒回收到！', '好的…（已枯萎）', '搜刮零食抽屉', '急需金钱疗法', '下班倒计时中', '好的马上办！', '信用卡账单暴击', '开会无底洞…', '咖啡强行续命', '又要写检讨？', '刷公司公账！', '呼叫救援队SOS', '关上下班卷帘门', '只盼周末活着', '明天休年假啦！'],
  '打工人求生日常 ②': ['收到综合症', '工资卡被路过', '冰美式急救', '方案又被退…', '这已是极限了', '被已读不回？', '逃离会议计划', '带薪洗手间避难', '下班脚底抹油', '今晚吃顿肉？', '对着屏幕发呆', '琢磨请假理由', '想回家了（泪）', '看着余额忍住', '今日成功渡劫！'],
  ...
  '二手交易・同城闲置 ①': ['请问是买家本人吗？', '爽快秒单感谢老板！', '大刀小刀谢绝还价', '信用极好满分买家！', '约好线下碰头地点', '快递已顺利寄出啦！', '单号发给您查收啦', '请问宝贝还在吗？', '成色很新保护极好', '原盒箱说配件齐全', '已到达面交地点啦！', '款项已成功转账啦', '奉上满满五星好评', '已为您保留宝贝啦', '打包防震结结实实'],
  '二手交易・同城闲置 ②': ['请不要玩失踪放鸽子', '提前五分钟已到现场', '恶意大砍价直接拉黑', '几乎全新闲置好物', '二手软件提示音响啦', '放门口无接触自提哦', '支持自提也可以包邮', '能秒拍的优先发货！', '附上专柜购买凭证', '排队等候漏单顺延', '当面结清一手交钱', '超值捡漏淘到宝啦！', '已举报不文明行为', '全新未拆封正品保障', '遇到神仙买家太开心'],
  ...
  '跑步・马拉松跑团 ①': ['今日跑步搞定！', '5公里完赛！', '稳住配速！', '新跑鞋开箱！', '心跳狂飙！', '跑团小伙伴集结', '晨跑空气太棒', '转动脚踝热身', '大口咕嘟补水', '刷新最佳战绩！', '雨中跑步浪漫', '慢慢调整呼吸', '挑战十公里！', '大汗淋漓爽快！', '明天接着跑！'],
  '跑步・马拉松跑团 ②': ['鞋带系紧系牢！', '心率很正常', '今日路线绝佳', '跑者高潮上头！', '夜跑吹风出发', '完赛奖牌咔嚓', '节奏不能乱！', '电解质水干杯', '泡沫轴嗷嗷叫', '跑步最自由了', '清晨空气漫步', '补充碳水大餐', '水泡是功勋章！', '跑步已上瘾', '明早闹钟已定'],
  ...
  '居家咖啡馆・甜品控 ①': ['甜品快乐糖分补给！', '同城面包探店小分队', '餐后甜点必须安排', '刚出炉盐面包香喷喷', '血糖告急急需补糖…', '迪拜巧克力成功拿下！', '每日一杯冰美式标配', '自制手冲治愈咖啡角', '满屋弥漫现磨咖啡香', '芝士蛋糕大口尝', '烘焙香气扑鼻太诱人', '严寒也要喝冰饮本命', '温暖治愈拉花拿铁', '小确幸甜进心坎里啦', '今日份快乐糖分达标！'],
  '居家咖啡馆・甜品控 ②': ['急需紧急注射咖啡因', '可颂锅巴酥脆嘎吱响', '被浓浓面包麦香勾魂', '浓缩双份浓缩加大马力', '厚厚盖上一层香浓奶油', '黄油香气瞬间大爆发！', '马卡龙软糯有嚼劲', '贝果厚涂浓郁奶酪酱', '麻烦换成无咖啡因豆', '专注手冲慢速滴滤中', '抵达梦幻甜点天花板', '外脆里嫩绝妙好滋味！', '苦甜交织沉浸式治愈', '吃完这顿明天再减肥！', '明天还要去打卡咖啡馆'],
  '网红快闪店・潮玩探店 ①': ['早起抢首发！', '排号100位', '周边断货啦（哭）', '限量款拿下！', '拍到人生照片！', '格调咖啡馆到', '地标打卡成功', '钱包彻底大开', '拍照区咔嚓！', '叫到我的号啦！', '豪华全套入手', '现场挤爆棚！', '圣水洞扫街中', '直接一键刷卡！', '下个快闪走起'],
  '网红快闪店・潮玩探店 ②': ['取号排队成功！', '展厅神仙机位', '看小票直摇头', '抢先拿下周边！', '地标打卡搞定', '贴纸入库啦！', '进场倒数三秒！', '和闺蜜开心拍', '体验互动集章', '拎着满袋战利品', '氛围感天花板', '没白白排队！', '特色街区漫步', '下季快闪必冲', '今天潮流达人'],
...
const CHARACTER_TAGS_KO = {
  '🐱 동물': ['시바견', '치즈냥', '포메라니안', '똥실똥실 토끼', '장난꾸러기 원숭이', '햄스터', '다람쥐', '아기 곰', '사막여우', '쿼카', '판다', '고슴도치', '알파카', '아기 돼지', '느릿느릿 나무늘보', '아기 코끼리', '웰시코기', '카피바라', '너구리', '아기 사자', '참지않는 말티즈', '동글동글 비숑', '골든리트리버', '삼색 고양이', '턱시도 고양이', '레서판다', '하얀 아기 양', '아기 사슴', '아기 호랑이', '캥거루', '하얗고 동글한 찹쌀떡 토끼', '잔망스러운 핑크 비버', '동태눈깔 곰돌이', '털 찐 시츄', '억울한 말티푸', '볼살 빵빵한 햄찌', '푸바오 스타일 아기 판다', '멍때리는 수달', '포동포동 친칠라', '느긋한 미어캣'],
  ...
  '🦎 파충류/양서류': ['핑크빛 우파루파 (아홀로틀)', '동글이 청개구리', '눈 땡글한 게코도마뱀', '색깔 바뀌는 카멜레온', '아기 거북이', '말랑말랑 도롱뇽', '귀여운 아기 악어', '미소 짓는 뱀', '아기 이구아나', '점박이 표범도마뱀 (레오파드 게코)', '화려한 독화살개구리', '느릿느릿 육지거북', '포동포동 화이트트리프로그', '물방울 삼킨 두꺼비', '귀여운 꼬마 악어'],
  '🦖 공룡/고생물': ['아기 티라노사우루스', '순둥이 브라키오사우루스', '귀여운 트리케라톱스', '하늘 나는 프테라노돈', '아기 스테고사우루스', '털복숭이 아기 매머드', '아기 벨로시랩터', '아기 안킬로사우루스', '날쌘돌이 벨로키랍토르', '빙하기 검치호 (스밀로돈)', '아기 모사사우루스', '귀여운 파라사우롤로푸스', '꼬마 익룡 베이비', '카리스마 아기 스피노사우루스', '목이 긴 아기 디플로도쿠스'],
  '🧸 인형/문구/팬시': ['빈티지 테디베어 곰인형', '낡은 애착 토끼인형', '포스트잇 요정', '다이어리 다꾸 스티커', '말랑 젤리 키링', '연필깎이 꼬마', '알록달록 크레파스봇', '미니 스노우볼', '포근한 쿠션 인형', '뽀글뽀글 털실 모루인형', '반짝이는 탑로더 포카 요정', '딸깍딸깍 3색 볼펜 요정', '다이어리 스탬프 요정', '알록달록 비즈 스트랩 키링', '폭신폭신 캐릭터 그립톡'],
  '👦 인물': ['단발머리 소녀', '안경 쓴 모범생', '투블럭 남학생', '뽀글머리 아줌마', '수염 난 아저씨', '포니테일 체육생', '양갈래 소녀', '비니 쓴 힙스터', '젠틀한 신사', '사랑스러운 꼬마', '프로페셔널 커리어우먼', '온화한 백발 할머니', '지팡이 짚은 할아버지', '귀여운 유치원생/어린이', '친절한 선생님/교사', '행복한 신랑/신부', '달콤한 신혼부부', '선글라스 낀 래퍼', '카페 바리스타', '까까머리 군인', '헤드폰 낀 프로게이머', '근육질 헬스보이', '카메라 든 배낭여행객', '따뜻한 의사선생님', '정의로운 경찰관', '기타 치는 록스타', '스케이트보드 타는 소년', '화려한 K팝 아이돌', '푸근한 동네 아저씨', '유연한 필라테스 강사', '열정적인 건축가', '파리지앵 화가', '스피드 라이더', '화사한 꽃집 사장님', '열공 취업준비생', '피곤한 직장인', '달콤한 파티시에/제빵사', '만능 엔지니어/메카닉', '지혜로운 선비', '서부 카우보이', '카리스마 해적 선장', '화려한 마술사', '우아한 발레리나', '천하태평 백수', '괴짜 천재 과학자', '풋풋한 대학생 훈남', '우아한 공주님', '용맹한 기사', '열정 태권도 사범', '상냥한 항공 승무원', '카메라맨', '프로 등산러/산악인', '뉴스 아나운서', '공정한 판사', '용감한 소방관', '미슐랭 스타 셰프', '생기발랄 알바생', '부지런한 청년 농부', '순수한 숲속 소녀', '명랑한 중고등학생', '파도를 가르는 서퍼', '간절한 취업준비생', '신입사원', '영혼 털린 직장인', '초보 운전자', '헬창/운동 마니아', '다크서클 후드티 개발자', '재택근무 프리랜서', '유튜버/크리에이터', '간호사/의료진', '공시생/자격증 준비생'],
  ...
  '👀 외형/특징': ['둥근 얼굴형', '크고 반짝이는 눈', '통통한 볼살', '짧고 통통한 팔다리', '작고 동그란 코', '발그레한 볼', '복슬복슬한 털', '말랑한 젤리 몸', '길고 쫑긋한 귀', '작은 송곳니', '주근깨', '한쪽 눈을 덮는 앞머리', '동그란 안경', '풍성한 꼬리', '작은 날개', '별 모양 눈동자', '하트 모양 볼무늬', '미니 SD 체형', '배만 뽈록 나온 아기 배 체형', '팔다리가 실처럼 긴 흐물흐물 체형', '2등신 극단적 숏다리 모찌 체형', '얼굴은 아기인데 몸은 반전 마초 체형', '동태눈깔에 마른 장작 체형', '통통하고 쫀득한 찹쌀떡 실루엣'],
  ...
  '💼 직장인/오피스': ['칼퇴 10초 전 시계 쳐다보는', '야근에 찌든 다크서클', '월급날 통장 보고 감격 눈물', '회의실에서 영혼 가출 멍때리기', '사직서 품에 살포시 안은', '커피 3잔 연속 수혈하기', '모니터 뒤에 몰래 숨은', '결재 서류 들고 눈치 보는', '출근길 만원 지하철 끼인', '점심 메뉴 고르며 행복해하는', '금요일 퇴근 발걸음 경쾌한', '월요병으로 침대와 한 몸', '무소음 마우스 광클하는', '듀얼 모니터에 눈 핑핑 도는', '점심 메뉴 고민에 세상 진지한', '연차 신청서 상신하고 두근두근', '경비 청구 영수증 풀칠하는'],
  '🎮 게임/E스포츠': ['RGB 게이밍 헤드셋 낀', '키보드 샷건 치며 분노', '랭크 승급하고 폭죽 터뜨리는', '트롤 팀원 보고 뒷목 잡는', '에너지 드링크 마시며 밤샘', 'VR 고글 쓰고 허공 휘젓는', '컨트롤러 쥐고 초집중 눈빛', '치킨이닭 1등 승리 세리머니', '와이파이 끊겨서 절망하는', '보스 레이드 파티 모집하는', '가챠 뽑기 대성공 환호', '가챠 폭망하고 바닥에 엎드림', '리듬게임 풀콤보 치는', '치킨/1등 먹고 승리 댄스 추는', '디스코드 마이크 테스트 아아', '스팀 세일에 장바구니 털린', '보스 레이드 1픽으로 누운'],
  '💘 연애/커플': ['시밀러룩 맞춰 입은', '손잡고 꽁냥꽁냥 걷는', '삐져서 볼 부풀리고 등 돌린', '보고 싶어서 영상통화 캡처', '하트 뿅뿅 쿠션 껴안은', '꽃다발 뒤에 얼굴 숨긴', '기념일 케이크 촛불 후 부는', '어깨에 기대어 꿀잠 자는', '손하트 발사하며 애교 부리기', '연락 기다리며 스마트폰 멍하니 보기', '영화관에서 팝콘 같이 집다가 손 닿은', '비 오는 날 우산 기울여 씌워주는', '인생네컷 부스에서 동물 머리띠 쓴', '맛있는 디저트 한 입 먹여주는', '비 오는 날 우산 더 기울여주는', '답장 기다리며 폰만 만지작거리는', '커플 폰케이스 맞추고 자랑하는'],
  '💪 헬스/다이어트': ['프로틴 쉐이커 쉑쉑 흔드는', '무거운 덤벨 번쩍 든', '인바디 체지방률 보고 충격', '샐러드 씹으며 치킨 상상하기', '러닝머신 위에서 땀 뻘뻘', '체중계 올라가고 좌절 눈물', '오운완 거울 셀카 찰칵', '스쿼트 하다가 다리 후들거리는', '스트레칭 폼롤러 위에서 비명', '물 2리터 벌컥벌컥 마시는', '근육 펌핑 거울 보며 흐뭇', '치팅데이 피자 버거 폭풍 흡입', '스트랩 감고 3대 500 외치는', '오운완 도장 캘린더에 쾅 찍는', '2리터 대용량 물통 챙겨든', '바벨 밑에 깔려서 눈 질끈 감은', '탄수화물 금단 현상에 바들바들 떠는'],
  '🌈 배경/효과': ['반짝반짝 빛나는 효과', '하트 뿅뿅 날리는', '별빛이 내리는', '네온사인 번쩍이는', '만화적인 집중선', '벚꽃이 흩날리는', '불타오르는 이펙트', '땀방울이 튀는', '우울한 먹구름', '무지개빛 아우라', '펑 터지는 폭발', '어두운 그림자', '스포트라이트 조명', '눈보라가 치는', '번개가 치는', '뽀글뽀글 거품', '따뜻한 햇살', '음표가 떠다니는', '바람에 흩날리는', '물음표 둥둥 (?)', '느낌표 번쩍 (!)', '부들부들 떨림선', '충격 먹구름', '하트 눈빛 (반짝)', '발바닥 불나게 호다닥 달리는 연출', '머리 위에 물음표 100개 폭발', '식은땀 삐질삐질 분수 연출', '충격받아 턱이 바닥까지 쿵 떨어진', '가슴 탕탕 치며 답답해하는 집중선', '사르르 녹아내리는 영혼 가출 효과'],
};

const CHARACTER_TAGS_EN = {
  '🐱 Animal': ['Shiba Inu', 'Orange Tabby Cat', 'Pomeranian', 'Chubby Bunny', 'Mischievous Monkey', 'Hamster', 'Squirrel', 'Baby Bear', 'Fennec Fox', 'Quokka', 'Panda', 'Hedgehog', 'Alpaca', 'Piglet', 'Lazy Sloth', 'Baby Elephant', 'Welsh Corgi', 'Capybara', 'Raccoon', 'Baby lion', 'Feisty Maltese', 'Fluffy Bichon Frise', 'Golden Retriever', 'Calico cat', 'Tuxedo cat', 'Red panda', 'White lamb', 'Baby deer', 'Baby tiger', 'Kangaroo', 'Chubby white mochi bunny', 'Mischievous pink beaver', 'Dead-eyed tired bear', 'Fluffy Shih Tzu pup', 'Sulky Maltipoo puppy', 'Chubby-cheek hamster', 'Fu Bao baby panda', 'Staring spacey otter', 'Plump fluffy chinchilla', 'Laid-back meerkat'],
  ...
  '🦎 Reptile/Amphibian': ['Pink axolotl (Wooper)', 'Round tree frog', 'Big-eyed gecko lizard', 'Color-shifting chameleon', 'Baby turtle', 'Soft salamander', 'Cute baby crocodile', 'Smiling snake', 'Baby iguana', 'Spotted Leopard Gecko', 'Colorful Poison Dart Frog', 'Slow land tortoise', 'Plump White\'s Tree Frog', 'Water drop toad', 'Cute baby alligator'],
  '🦖 Dinosaur': ['Baby T-Rex', 'Gentle Brachiosaurus', 'Cute Triceratops', 'Flying Pteranodon', 'Baby Stegosaurus', 'Fluffy baby mammoth', 'Baby Velociraptor', 'Baby Ankylosaurus', 'Zippy Velociraptor', 'Ice Age Saber-toothed cat', 'Baby Mosasaurus', 'Cute Parasaurolophus', 'Baby Pterodactyl', 'Charismatic baby Spinosaurus', 'Long-necked baby Diplodocus'],
  '🧸 Plushie/Stationery': ['Vintage teddy bear', 'Well-loved bunny plushie', 'Post-it memo fairy', 'Journal deco sticker', 'Squishy jelly keychain', 'Pencil sharpener kid', 'Colorful crayon bot', 'Mini snow globe', 'Cozy cushion doll', 'Fluffy wire pipe cleaner doll', 'Sparkling toploader photocard fairy', 'Clicking 3-color ballpen fairy', 'Diary rubber stamp fairy', 'Colorful beaded strap keyring', 'Plush character pop-socket'],
  '👦 Person': ['Bob cut girl', 'Nerdy student with glasses', 'Two-block cut boy', 'Permed middle-aged woman', 'Bearded uncle', 'Ponytail athlete', 'Pigtail girl', 'Beanie hipster', 'Gentleman in suit', 'Child in Hanbok', 'Career woman in suit', 'Gentle white-haired grandmother', 'Grandfather with cane', 'Cute kindergartener/child', 'Kind teacher/educator', 'Happy groom/bride', 'Sweet newlyweds', 'Rapper with shades', 'Barista with apron', 'Buzz cut soldier', 'Pro gamer with headset', 'Muscular gym bro', 'Backpacker with camera', 'Doctor in white coat', 'Courageous police officer', 'Rock star playing guitar', 'Skater boy', 'Glamorous K-Pop idol', 'Friendly neighborhood guy', 'Yoga instructor', 'Architect in hard hat', 'Parisian artist', 'Biker rider', 'Florist shop owner', 'Job seeker with backpack', 'Tired office worker', 'Baker in apron', 'Skillful mechanic', 'Scholar in traditional robe', 'Cowboy hat rancher', 'Pirate captain with eyepatch', 'Glamorous magician', 'Ballerina in tutu', 'Slacker in tracksuit', 'Scientist in lab coat', 'Handsome guy in tee and jeans', 'Princess in ballgown', 'Knight in shining armor', 'Taekwondo master', 'Flight attendant in uniform', 'Cameraman', 'Hiker in mountain gear', 'Announcer with microphone', 'Judge in legal robe', 'Firefighter in gear', 'Chef in toque', 'Part-timer in cap', 'Farmer in straw hat', 'Forest maiden in flower crown', 'Student eating tteokbokki', 'Surfer with surfboard', 'Hair roller job seeker', 'Rookie employee', 'Burnout office worker', 'Student beginner driver', 'Gym fitness enthusiast', 'Hoodie developer with dark circles', 'Remote work freelancer', 'YouTuber creator', 'Nurse healthcare worker', 'Civil exam student'],
  ...
  '👀 Appearance': ['Round face shape', 'Large sparkling eyes', 'Chubby cheeks', 'Short chubby limbs', 'Small round nose', 'Rosy blushed cheeks', 'Fluffy soft fur', 'Soft squishy jelly body', 'Long perky ears', 'Tiny fangs', 'Cute freckles', 'Bangs covering one eye', 'Round glasses', 'Fluffy voluminous tail', 'Tiny fairy wings', 'Star-shaped pupils', 'Heart cheek pattern', 'Mini chibi SD body', 'Potbelly chubby tummy silhouette', 'Long noodly wobbly limbs body', '2-head extreme short-legged chibi body', 'Cute baby face with buff muscular body', 'Lifeless dead eyes skinny stick body', 'Plump squishy chewy mochi silhouette'],
  ...
  '🎒 Prop/Action': ['Holding smartphone', 'Holding coffee cup', 'Wearing sunglasses', 'Wearing headphones', 'Working on laptop', 'Reading a book', 'Holding a balloon', 'Holding flower bouquet', 'Singing into microphone', 'Holding game controller', 'Holding frying pan', 'Holding large magnifying glass', 'Drawing in sketchbook', 'Waving magic wand', 'Holding grocery basket', 'Holding an umbrella', 'Eating popcorn', 'Vacuuming floor', 'Peeking through binoculars', 'Stretching on yoga mat', 'Checking smartwatch', 'Holding stacks of cash', 'Holding iced Americano tumbler', 'Typing on laptop', 'Eating fried chicken drumstick', 'Clinking beer/soju glasses', 'Getting IV drip while exhausted', 'Sprawled flat out on bed', 'Banging wall weeping loudly', 'Wrapped in blanket like kimbap roll', 'Browsing delivery app mouth watering', 'Shivering with thermometer in mouth', 'Covering mouth seeing bank balance', 'Shouting loudly through megaphone', 'Peeking suspiciously over sunglasses', 'Mouth wide open in front of fan', 'Splashing puddles in yellow raincoat and boots', 'Melting in heatwave fanning desperately', 'Buried in long puffer jacket peeking eyes', 'Cozy wrapped thick scarf blowing warm breath', 'Napping on picnic mat under cherry blossoms', 'Walking on autumn leaves in trench coat'],
  ...
  '💼 Office & Work': ['Watching clock 10s before clock-out', 'Dark circles from overtime work', 'Tears of joy on payday', 'Soul leaving body during meetings', 'Holding resignation letter in pocket', 'Drinking 3 cups of coffee in a row', 'Hiding behind computer monitor', 'Checking boss mood with approval folder', 'Squished in crowded morning subway', 'Happy while picking lunch menu', 'Bouncy joyful Friday clock-out walk', 'Glued to bed with Monday blues', 'Spam clicking silent mouse', 'Dizzy looking at dual monitors', 'Ultra serious picking lunch menu', 'Heart racing submitting PTO request', 'Gluing receipts for expense claim'],
  '🎮 Gaming & Esports': ['Wearing RGB gaming headset', 'Raging and smashing keyboard', 'Confetti celebration on rank up', 'Holding neck in rage at troll teammates', 'All-nighter with energy drinks', 'Swinging arms in VR goggles', 'Laser focus holding controller', 'Winner winner chicken dinner ceremony', 'Despair when Wi-Fi disconnects', 'Recruiting for boss raid party', 'Cheering on gacha jackpot pull', 'Face down crying after failed gacha', 'Hitting full combo in rhythm game', 'Dancing victory dance after 1st place', 'Discord mic test check check', 'Wallet emptied during Steam sale', 'Downed first in boss raid'],
  '💘 Romance & Couples': ['Wearing matching couple outfits', 'Holding hands walking sweetly', 'Pouting with puffed cheeks facing away', 'Taking screenshot on video call', 'Hugging glowing heart cushion', 'Hiding face behind flower bouquet', 'Blowing out anniversary cake candle', 'Sleeping sweetly on shoulder', 'Sending finger heart aegyo', 'Staring at phone waiting for text', 'Touching hands over cinema popcorn', 'Tilting umbrella to share in rain', 'Wearing animal headband in photo booth', 'Feeding a bite of yummy dessert', 'Tilting umbrella closer in rain', 'Fidgeting with phone waiting for text', 'Showing off matching couple phone cases'],
  '💪 Fitness & Diet': ['Shaking protein shaker bottle', 'Lifting heavy dumbbell with pride', 'Shocked looking at InBody body fat scan', 'Chewing salad dreaming of fried chicken', 'Sweating profusely on treadmill', 'Crying in despair on weighing scale', 'Snapping gym mirror selfie (OOTD)', 'Legs shaking after heavy squats', 'Screaming on foam roller stretch', 'Gulping down 2L water bottle', 'Smiling admiring muscle pump in mirror', 'Devouring pizza and burgers on cheat day', 'Strapped up yelling big 3 lifts', 'Stamping workout complete on calendar', 'Carrying huge 2-liter water bottle', 'Pinned under barbell eyes shut tight', 'Shivering from carb withdrawal'],
  '🌈 Effect/BG': ['Sparkling glittering effect', 'Hearts fluttering around', 'Starlight falling', 'Neon signs blinking', 'Comic action speed lines', 'Cherry blossom petals swirling', 'Blazing fire effect', 'Sweat drops splashing', 'Gloomy rain cloud', 'Rainbow aura', 'Boom explosion', 'Dark ominous shadow', 'Spotlight illumination', 'Blizzard snowstorm', 'Lightning flash', 'Bubbles floating', 'Warm gentle sunshine', 'Musical notes floating', 'Blowing in the wind', 'Floating question marks (?)', 'Sparking exclamation mark (!)', 'Shivering tremble lines', 'Shock dark cloud', 'Heart sparkle eyes', 'Running at lightning speed dash clouds', '100 question marks popping over head', 'Fountain of nervous cold sweat drops', 'Jaw dropped to the floor shock effect', 'Thumping chest in frustration speedlines', 'Melting puddle soul leaving body effect'],
};

const CHARACTER_TAGS_JA = {
  '🐱 動物': ['柴犬', '茶トラ猫', 'ポメラニアン', 'まんまるウサギ', 'いたずら子猿', 'ハムスター', 'リス', '子グマ', 'フェネック', 'クアッカワラビー', 'パンダ', 'ハリネズミ', 'アルパカ', '子ブタ', 'のんびりナマケモノ', '子象', 'コーギー', 'カピバラ', 'アライグマ', '赤ちゃんライオン', '強気なマルチーズ', 'ふわもこビション・フリーゼ', 'ゴールデンレトリバー', '三毛猫', 'タキシード猫', 'レッサーパンダ', '白い子羊', '子鹿', '赤ちゃんトラ', 'カンガルー', 'モチモチ白うさぎ', 'あざと可愛いピンクビーバー', '死んだ目のくま', 'もふもふシーズー', 'しょんぼりマルプー', 'ほっぺパンパンハムスター', '福宝（フーバオ）風子パンダ', 'ぼーっとするカワウソ', 'まんまるチンチラ', 'のんびりミーアキャット'],
  ...
  '👀 外見/特徴': ['丸顔', '大きくてキラキラした目', 'ぷっくりした頬', '短くて太い手足', '小さくて丸い鼻', 'ほんのり赤らんだ頬', 'もふもふの毛並み', 'ぷにぷにゼリー体型', '長くてぴんと立った耳', '小さな八重歯', 'そばかす', '片目を隠す前髪', '丸メガネ', 'ふさふさのしっぽ', '小さな羽', '星形の瞳', 'ハート型の頬模様', 'ミニSD体型', 'ぽっこりお腹の幼児体型', '手足がひょろひょろ長い軟体ボディ', '2頭身・極端な短足もちもち体型', '顔は赤ちゃん・体はムキムキギャップ体型', '死んだ魚の目にガリガリ体型', 'もちもち弾力のある大福シルエット'],
  ...
  '💼 会社員・オフィス': ['定時退社10秒前に時計を見る', '残業で目の下のクマがやばい', '給料日に通帳を見て感動の涙', '会議中に魂が抜けて放心状態', '退職届を胸に忍ばせる', 'コーヒー3杯一気飲み', 'モニターの陰に隠れる', '決裁書類を持って顔色を伺う', '満員電車に押しつぶされる', 'ランチメニュー選びで幸せ', '金曜の退勤で足取りが軽い', '月曜病でベッドと一体化', '静音マウスを連打する', 'デュアルモニターで目が回る', 'ランチ選びに超真剣な', '有休申請ポチってドキドキ', '経費精算レシート糊付け中'],
  '🎮 ゲーム・eスポーツ': ['RGBゲーミングヘッドセット装着', 'キーボード台パンでブチギレ', 'ランク昇格で紙吹雪クラッカー', 'トロール味方に頭を抱える', 'エナジードリンクで徹夜ゲーム', 'VRゴーグルで虚空を振り回す', 'コントローラー握り超集中', '1位ドン勝ビクトリーセレモニー', 'Wi-Fi切断で絶望する', 'ボス討伐レイドパーティ募集', 'ガチャ大当たりで大歓喜', 'ガチャ爆死で床に崩れ落ちる', '音ゲーでフルコンボ決める', 'ドン勝／1位取って勝利ダンス', 'Discordマイクテストあーあー', 'Steamセールで散財した', 'ボスレイドで真っ先に即死した'],
  '💘 恋愛・カップル': ['ペアルックでお揃いコーデ', '手を繋いでイチャイチャ散歩', 'すねてほっぺを膨らませ背を向ける', '会いたくてビデオ通話スクショ', 'ハートクッションをぎゅっと抱きしめる', '花束の後ろに顔を隠す', '記念日ケーキのロウソクを吹き消す', '肩にもたれかかってぐっすり眠る', '指ハート発射で甘える', '返信を待ちながらスマホをぼんやり見つめる', '映画館でポップコーンを取り合い手が触れる', '雨の日に傘を傾けて入れてあげる', 'プリクラでカチューシャ付ける', '美味しいスイーツをアーンする', '雨の日に傘をもっと傾ける', '返信待ちでスマホ握りしめる', 'お揃いスマホケース見せびらかす'],
  '💪 フィットネス・筋トレ': ['プロテインシェイカーをシャカシャカ振る', '重いダンベルを力強く持ち上げる', '体組成計の体脂肪率を見て大ショック', 'サラダを食べながらチキンを妄想', 'ランニングマシンで汗だく', '体重計に乗って絶望の涙', 'ジムの鏡で筋トレ自撮りパシャリ', 'スクワットで足がプルプル震える', 'フォームローラーの上で悲鳴', '水2リットルを一気飲み', '筋肉のパンプアップを見て満足気', 'チートデイにピザとバーガーを爆食い', 'リストストラップ巻いてBIG3叫ぶ', '筋トレ完了スタンプをポンと押す', '2L巨大水筒持ち歩く', 'バーベルの下敷きになって目をつぶる', '炭水化物禁断症状でプルプル震える'],
  '🌈 エフェクト/背景': ['キラキラ光るエフェクト', 'ハートが飛び交う', '星が降る', 'ネオンサインが瞬く', '漫画的な集中線', '桜吹雪が舞う', '燃え上がる炎エフェクト', '汗が飛び散る', '憂鬱な暗雲', '虹色のオーラ', 'ドカンと爆発', '不気味な影', 'スポットライト照明', '吹雪が吹き荒れる', '雷が鳴り響く', 'ぷくぷく泡', '温かい日差し', '音符が漂う', '風に舞う', 'ふわふわ浮かぶはてな（？）', 'キラリと光るびっくりマーク（！）', 'ブルブル震える効果線', 'ショックの暗雲', '目がハート（キラキラ）', '足元から煙が出る猛ダッシュ効果', '頭の上にハテナ100個大爆発', '冷や汗ダラダラ噴水エフェクト', '顎が床まで外れる大ショック演出', '胸をドンドン叩く悔しさ集中線', '魂が抜けてとろりと溶け出す効果'],
};

const CHARACTER_TAGS_ZH = {
  '🐱 动物': ['柴犬', '橘猫', '博美犬', '圆滚滚小兔', '淘气小猴', '仓鼠', '松鼠', '小熊', '耳廓狐', '短尾矮袋鼠', '大熊猫', '刺猬', '羊驼', '小猪', '树懒', '小象', '柯基', '水豚', '浣熊', '小狮子', '脾气火爆马尔济斯', '圆滚滚比熊犬', '金毛寻回犬', '三花猫', '奶牛猫（燕尾服猫）', '小熊猫', '白色小羊', '小鹿', '小老虎', '袋鼠', '雪白圆滚滚大福兔', '古灵精怪粉色海狸', '眼神空洞死鱼眼小熊', '毛茸茸西施犬', '委屈巴巴马尔泰犬', '腮帮鼓鼓小仓鼠', '福宝风大熊猫宝宝', '发呆呆萌小水獭', '圆滚滚龙猫（毛丝鼠）', '悠闲细尾獴（猫鼬）'],
  ...
  '🦎 爬行・两栖类': ['粉色六角恐龙（美西螈）', '圆滚滚小青蛙', '大眼睛守宫蜥蜴', '变色龙', '小海龟', '软糯小蝾螈', '可爱小鳄鱼', '微笑小蛇', '小鬣蜥', '斑点豹纹守宫壁虎', '绚丽箭毒蛙', '慢吞吞小陆龟', '肉嘟嘟白氏树蛙', '吞下水滴小蟾蜍', '软萌小鳄鱼'],
  '🦖 恐龙・古生物': ['霸王龙宝宝', '温顺腕龙', '可爱三角龙', '飞天翼龙', '剑龙宝宝', '毛茸茸小猛犸象', '迅猛龙宝宝', '甲龙宝宝', '敏捷小巧迅猛龙', '冰河世纪剑齿虎', '沧龙小宝宝', '呆萌副栉龙', '扑棱小翼龙幼崽', '霸气小棘龙宝宝', '长脖子小梁龙'],
  '🧸 玩偶・文具': ['复古泰迪熊', '依恋小兔玩偶', '便利贴精灵', '手帐装饰贴纸', 'Q弹果冻钥匙扣', '卷笔刀小人', '彩色蜡笔机器人', '迷你水晶雪花球', '软绵绵靠垫玩偶', '毛茸茸手工扭扭棒小偶', '闪亮硬卡套小卡精灵', '按动咔哒三色圆珠笔精灵', '手账印章小精灵', '彩色串珠手机挂绳钥匙扣', '软乎乎角色气囊手机支架'],
  '👦 人物': ['短发少女', '戴眼镜的学霸', '寸头男生', '卷发大妈', '胡子大叔', '马尾体育生', '双马尾少女', '冷帽潮人', '西装绅士', '穿韩服的小朋友', '职场女强人', '慈祥的白发奶奶', '拄拐杖的爷爷', '小黄帽幼儿园生', '戴墨镜的Rapper', '咖啡馆咖啡师', '寸头士兵', '戴耳机的职业选手', '肌肉健身男', '带单反的背包客', '穿白大褂的医生', '穿制服的警察', '弹吉他的摇滚乐手', '滑板少年', '华丽K-POP爱豆', '热心邻居大叔', '瑜伽教练', '戴安全帽的建筑师', '巴黎画家', '机车骑手', '花店老板', '背书包的求职生', '疲惫打工人', '系围裙的面包师', '工装机修师', '传统学者', '牛仔帽牧童', '戴眼罩的海盗船长', '魔术师', '芭蕾舞者', '运动服无业青年', '穿白大褂的科学家', '白T牛仔裤帅哥', '穿礼服的小公主', '穿铠甲的骑士', '穿道服的跆拳道教练', '穿制服的空姐', '摄影师', '穿冲锋衣的登山客', '拿话筒的主持人', '穿法袍的法官', '穿防护服的消防员', '戴厨师帽的主厨', '戴棒球帽的店员', '草帽农夫', '戴花环的森林少女', '穿校服吃年糕的学生', '拿冲浪板的冲浪者', '戴卷发筒的求职生', '职场新人', '灵魂出窍打工人', '新手司机', '健身肌肉达人', '黑眼圈连帽衫程序员', '居家办公自由职业者', '博主网红/内容创作者', '护士白衣天使', '考公开挂备考生'],
  ...
  '👀 外貌/特征': ['圆圆脸', '大而闪亮的眼睛', '肉嘟嘟脸颊', '短粗小手小脚', '小巧圆鼻子', '泛红的脸颊', '蓬松柔软毛发', 'Q弹果冻身材', '直立长耳朵', '可爱小虎牙', '雀斑', '遮单眼的刘海', '圆圆眼镜', '毛茸茸大尾巴', '小翅膀', '星星眼瞳孔', '爱心脸颊纹', '迷你SD身材', '圆滚滚小肚腩萌宝身材', '四肢纤长面条般柔软搞怪身材', '二头身极致小短腿糯米团身材', '奶萌娃娃脸搭配健硕肌肉反差身材', '死鱼眼配干瘪柴火身材', 'Q弹软糯年糕轮廓剪影'],
  ...
  '🎒 道具/动作': ['拿手机', '端咖啡杯', '戴墨镜', '戴头戴式耳机', '操作笔记本电脑', '看书', '拿气球', '抱花束', '握麦克风唱歌', '握游戏手柄', '拿平底锅', '拿大放大镜', '在画本上画画', '挥动魔法棒', '提菜篮子', '撑伞', '吃爆米花', '吸尘器打扫', '拿望远镜看', '在瑜伽垫上拉伸', '看智能手表', '拿一沓钞票', '拿冰美式随行杯', '敲笔记本键盘', '啃炸鸡腿', '碰啤酒杯干杯', '打点滴精疲力尽', '穿黄色小雨衣雨靴踩水坑玩耍', '酷暑暴晒热化了疯狂摇蒲扇', '裹在超大长羽绒服里只露眼睛', '大厚围巾缠满脖子哈热气取暖', '在樱花雨飘落的野餐垫上睡午觉', '穿经典风衣漫步脚踩金色落叶'],
  ...
  '💼 职场・办公': ['下班倒计时10秒看表', '熬夜加班黑眼圈', '发薪日看账单感动落泪', '会议室灵魂出窍发呆', '口袋揣着辞职信', '连灌3杯咖啡续命', '躲在电脑显示器后', '拿着审批单看老板眼色', '早高峰挤爆地铁', '挑选午餐菜单超幸福', '周五下班步伐轻快', '周一综合征粘在床上', '疯狂狂点静音鼠标', '双屏幕看到眼花缭乱', '纠结午饭吃什么无比严肃', '提交年假申请心跳加速', '贴发票报销贴到头大'],
  '🎮 游戏・电竞': ['戴RGB电竞耳机', '狂砸键盘暴怒', '段位升级放彩花', '看坑货队友捂后颈', '喝能量饮料通宵', '戴VR眼镜隔空比划', '握手柄超专注眼神', '吃鸡第一名胜利狂欢', '断网绝望抓狂', '招募打Boss车队', '抽卡爆金光大狂欢', '抽卡沉船趴地大哭', '音游手速全开狂打全连全连', '吃鸡大吉大利跳胜利之舞', '开黑语音试麦喂喂喂', 'Steam大促清空购物车荷包大失血', '打大团本第一个光速躺地'],
  '💘 恋爱・情侣': ['穿情侣装CP穿搭', '牵手甜蜜散步', '生气鼓脸背过身', '想你视频通话截屏', '紧抱爱心抱枕', '躲在花束后偷看', '吹灭纪念日蛋糕蜡烛', '靠在肩膀甜甜熟睡', '发射手指爱心撒娇', '盯着手机等回复', '电影院抓爆米花碰到手', '下雨天伞歪向对方', '拍大头贴戴可爱动物发箍', '甜美投喂一口好吃甜品', '下雨天伞更加偏向对方', '等消息捧着手机心神不宁', '晒出情侣手机壳秀恩爱'],
  '💪 健身・减肥': ['用力摇蛋白粉摇摇杯', '举起重哑铃展示力量', '看体脂率报告大震惊', '嚼着沙拉幻想炸鸡', '跑步机上挥汗如雨', '站上体重秤绝望落泪', '对镜拍打卡照OOTD', '深蹲完双腿颤抖', '泡沫轴上痛苦尖叫', '吨吨吨狂喝2L水', '对镜欣赏肌肉充血', '放纵日暴风吸入披萨汉堡', '绑紧助力带大喊三大项冲大重量', '日历上狠狠盖上今日打卡印章', '拎着两升吨吨桶大水壶', '被杠铃压住生无可恋闭紧双眼', '戒碳水断糖馋到浑身瑟瑟发抖'],
  '🌈 背景/特效': ['闪闪发光特效', '爱心四处飞舞', '星光洒落', '霓虹招牌闪烁', '漫画集中动作速度线', '樱花雨漫天飘落', '烈火燃烧特效', '汗珠四溅', '忧郁乌云小雨', '彩虹色光晕', '砰然大爆炸', '暗黑神秘阴影', '聚光灯焦点照明', '暴风雪席卷', '电闪雷鸣', '咕嘟咕嘟小气泡', '温暖柔和阳光', '音符悠扬飘浮', '随风飘舞', '问号飘浮（？）', '闪亮感叹号（！）', '瑟瑟发抖颤抖线', '大受打击黑线乌云', '爱心星星眼（闪烁）', '脚底冒烟风驰电掣狂奔特效', '头顶满天问号大爆发', '冷汗直冒瀑布喷泉特效', '下巴惊掉砸在地上大震惊', '捶胸顿足抓狂集中速度线', '灵魂出窍化作一滩烂泥溶化特效'],
};
...
function App() {
  ...
  const getDynamicPhraseFontSize = (str = '') => {
    ...
    if (len <= 5) return 'text-[10.5px] sm:text-[12px] md:text-[12.5px] font-semibold tracking-normal';
    if (len <= 8) return 'text-[10.25px] sm:text-[11.5px] md:text-[12px] font-semibold tracking-tight';
    if (len <= 11) return 'text-[10px] sm:text-[11px] md:text-[11.5px] font-semibold tracking-tight';
    if (len <= 14) return 'text-[9.75px] sm:text-[10.5px] md:text-[11px] font-semibold tracking-tight';
    return 'text-[9.5px] sm:text-[10px] md:text-[10.5px] font-semibold tracking-tighter';
  };
...
Do not follow the photo's photorealistic rendering. Apply the selected art style's expression method strongly. The character's stylistic identity should be felt first, while on closer inspection the subject from the photo should still be recognizable.`,
  ...
  const getExpandedArtStyleText = (styleTag, isKo) => {
    const styleMap = {
      '귀여운 2D 만화풍': {
        ko: '깔끔하고 둥글둥글한 외곽선과 단순하지만 생동감 있는 형태가 돋보이는 고품질 2D 카툰 스타일. 밝은 플랫컬러와 부드러운 셀 셰이딩을 사용하고, 작은 화면에서도 표정과 실루엣이 즉시 읽히도록 명확하게 정리하며 실사 질감과 과도한 입체 명암은 피하세요.',
        en: 'high-quality cute 2D cartoon style with clean rounded outlines and simple lively shapes. Use bright flat colors with soft cel shading, keep expressions and silhouettes instantly readable at small size, and avoid photorealistic texture or overly volumetric rendering.'
      },
      'Cute 2D cartoon': {
        ko: '깔끔하고 둥글둥글한 외곽선과 단순하지만 생동감 있는 형태가 돋보이는 고품질 2D 카툰 스타일. 밝은 플랫컬러와 부드러운 셀 셰이딩을 사용하고, 작은 화면에서도 표정과 실루엣이 즉시 읽히도록 명확하게 정리하며 실사 질감과 과도한 입체 명암은 피하세요.',
        en: 'high-quality cute 2D cartoon style with clean rounded outlines and simple lively shapes. Use bright flat colors with soft cel shading, keep expressions and silhouettes instantly readable at small size, and avoid photorealistic texture or overly volumetric rendering.'
      ...
      '한국 웹툰 스타일': {
        ko: '깔끔한 디지털 라인아트와 또렷한 외곽선, 현대적인 색감과 선명한 표정 연출이 특징인 한국 웹툰 스타일. 부드러운 셀 셰이딩과 절제된 그라데이션을 사용해 감정을 한눈에 전달하고, 복잡한 브러시 질감보다 정돈된 형태와 색 분리를 우선하세요.',
        en: 'clean Korean webtoon style with crisp digital line art, modern color treatment, and highly readable facial acting. Combine soft cel shading with restrained gradients, prioritize clear shape separation, and avoid overly painterly brush texture.'
      },
      'Korean webtoon style': {
        ko: '깔끔한 디지털 라인아트와 또렷한 외곽선, 현대적인 색감과 선명한 표정 연출이 특징인 한국 웹툰 스타일. 부드러운 셀 셰이딩과 절제된 그라데이션을 사용해 감정을 한눈에 전달하고, 복잡한 브러시 질감보다 정돈된 형태와 색 분리를 우선하세요.',
        en: 'clean Korean webtoon style with crisp digital line art, modern color treatment, and highly readable facial acting. Combine soft cel shading with restrained gradients, prioritize clear shape separation, and avoid overly painterly brush texture.'
      ...
      'B급 병맛/코믹 짤툰풍': {
        ko: '굵고 투박한 자유로운 펜선과 일부러 어설픈 듯한 형태, 극도로 과장된 표정과 황당한 상황 연출이 살아있는 B급 병맛 웹툰/짤툰 스타일. 예쁘게 다듬기보다 웃음과 임팩트를 우선하고, 단순한 실루엣 안에서 개그 타이밍과 감정 왜곡을 과감하게 표현하세요.',
        en: 'satirical B-grade meme-webtoon style with bold rough linework, intentionally awkward forms, hyper-expressive faces, and absurd comic staging. Prioritize humor and impact over prettification while keeping the silhouette simple and readable.'
      },
      'Meme Webtoon Satirical Style': {
        ko: '굵고 투박한 자유로운 펜선과 일부러 어설픈 듯한 형태, 극도로 과장된 표정과 황당한 상황 연출이 살아있는 B급 병맛 웹툰/짤툰 스타일. 예쁘게 다듬기보다 웃음과 임팩트를 우선하고, 단순한 실루엣 안에서 개그 타이밍과 감정 왜곡을 과감하게 표현하세요.',
        en: 'satirical B-grade meme-webtoon style with bold rough linework, intentionally awkward forms, hyper-expressive faces, and absurd comic staging. Prioritize humor and impact over prettification while keeping the silhouette simple and readable.'
      ...
      '손그림 낙서풍': {
        ko: '삐뚤빼뚤한 손맛과 자연스러운 선 떨림이 살아있는 핸드드로운 낙서 일러스트 스타일. 선을 지나치게 정제하지 말고 유기적으로 흐르게 하며, 가벼운 연필 또는 파스텔 채색과 여백을 활용해 소박하고 따뜻한 아날로그 감성을 유지하세요.',
        en: 'charming hand-drawn doodle style with organic imperfect strokes and natural line wobble. Keep the drawing intentionally unpolished, use light pencil or pastel fills with breathing room, and preserve a warm handmade analog feeling.'
      },
      'Hand-drawn doodle': {
        ko: '삐뚤빼뚤한 손맛과 자연스러운 선 떨림이 살아있는 핸드드로운 낙서 일러스트 스타일. 선을 지나치게 정제하지 말고 유기적으로 흐르게 하며, 가벼운 연필 또는 파스텔 채색과 여백을 활용해 소박하고 따뜻한 아날로그 감성을 유지하세요.',
        en: 'charming hand-drawn doodle style with organic imperfect strokes and natural line wobble. Keep the drawing intentionally unpolished, use light pencil or pastel fills with breathing room, and preserve a warm handmade analog feeling.'
      ...
      '크레파스/오일파스텔 동화풍': {
        ko: '포근한 종이결 위에 크레파스와 오일파스텔을 겹겹이 문질러 올린 듯한 따뜻한 동화책 일러스트 스타일. 부드러운 파스텔 색과 입자감, 손으로 문지른 가장자리와 자연스러운 색 겹침을 살리고, 매끈한 디지털 벡터나 플라스틱 광택은 피하세요.',
        en: 'warm storybook illustration with layered crayon and oil-pastel pigment over soft paper grain. Preserve tactile grain, softly smudged edges, and natural color layering, while avoiding sterile vector smoothness or plastic gloss.'
      },
      'Crayon & Oil Pastel Storybook Style': {
        ko: '포근한 종이결 위에 크레파스와 오일파스텔을 겹겹이 문질러 올린 듯한 따뜻한 동화책 일러스트 스타일. 부드러운 파스텔 색과 입자감, 손으로 문지른 가장자리와 자연스러운 색 겹침을 살리고, 매끈한 디지털 벡터나 플라스틱 광택은 피하세요.',
        en: 'warm storybook illustration with layered crayon and oil-pastel pigment over soft paper grain. Preserve tactile grain, softly smudged edges, and natural color layering, while avoiding sterile vector smoothness or plastic gloss.'
      ...
      // 1. 정통 무협 만화풍
      '정통 무협 만화풍': {
        ko: '거친 먹선과 강한 필압 변화, 마른 붓의 갈필, 역동적인 동세와 기운의 흐름이 살아있는 정통 무협 만화 스타일. 옷자락과 머리카락, 검기와 속도선을 박력 있게 살리고 강한 흑백 대비로 비장한 카리스마를 표현하되 귀여운 일반 카툰 톤으로 평균화하지 마세요.',
        en: 'authentic martial-arts wuxia comic style with rugged dry-brush ink, forceful pressure variation, dramatic motion, and flowing energy. Emphasize garments, hair, speed lines, and high-contrast heroic tension without averaging the result into a generic cute cartoon.'
      },
      'Classic Martial Arts Wuxia Style': {
        ko: '거친 먹선과 강한 필압 변화, 마른 붓의 갈필, 역동적인 동세와 기운의 흐름이 살아있는 정통 무협 만화 스타일. 옷자락과 머리카락, 검기와 속도선을 박력 있게 살리고 강한 흑백 대비로 비장한 카리스마를 표현하되 귀여운 일반 카툰 톤으로 평균화하지 마세요.',
        en: 'authentic martial-arts wuxia comic style with rugged dry-brush ink, forceful pressure variation, dramatic motion, and flowing energy. Emphasize garments, hair, speed lines, and high-contrast heroic tension without averaging the result into a generic cute cartoon.'
      ...
      // 2. 고전 동양화/민화풍
      '고전 동양화/민화풍': {
        ko: '전통 한지의 섬유결과 또렷한 먹선 윤곽, 오방색과 광물 안료를 연상시키는 풍성한 전통 채색이 어우러진 고전 동양화·민화 스타일. 평면적이면서 장식적인 구성, 해학적인 표정과 상징성을 살리고 현대적인 셀 셰이딩이나 플라스틱 광택은 줄이세요.',
        en: 'traditional Korean Minhwa and classical East Asian painting style with fibrous hanji texture, crisp ink contours, and rich mineral-pigment-inspired color. Favor decorative flat composition, symbolic humor, and handcrafted charm over modern cel shading or plastic gloss.'
      },
      'Traditional Oriental Folk Art (Minhwa) Style': {
        ko: '전통 한지의 섬유결과 또렷한 먹선 윤곽, 오방색과 광물 안료를 연상시키는 풍성한 전통 채색이 어우러진 고전 동양화·민화 스타일. 평면적이면서 장식적인 구성, 해학적인 표정과 상징성을 살리고 현대적인 셀 셰이딩이나 플라스틱 광택은 줄이세요.',
        en: 'traditional Korean Minhwa and classical East Asian painting style with fibrous hanji texture, crisp ink contours, and rich mineral-pigment-inspired color. Favor decorative flat composition, symbolic humor, and handcrafted charm over modern cel shading or plastic gloss.'
      ...
      // 3. 은은한 수묵담채화풍
      '은은한 수묵담채화풍': {
        ko: '먹의 섬세한 농담과 살아있는 붓압, 촉촉한 발묵과 투명한 담채 번짐, 넉넉한 여백이 조화를 이루는 서정적인 수묵담채화 스타일. 선과 색을 절제하면서도 생동감을 유지하고, 네온 컬러·딱딱한 벡터 윤곽·강한 디지털 광택은 피하세요.',
        en: 'poetic East Asian sumi-e ink-wash style with nuanced ink gradation, expressive brush pressure, wet blooming, translucent light color washes, and generous negative space. Keep it restrained yet alive, avoiding neon color, rigid vector edges, or strong digital gloss.'
      },
      'Delicate Ink Wash & Light Watercolor Style': {
        ko: '먹의 섬세한 농담과 살아있는 붓압, 촉촉한 발묵과 투명한 담채 번짐, 넉넉한 여백이 조화를 이루는 서정적인 수묵담채화 스타일. 선과 색을 절제하면서도 생동감을 유지하고, 네온 컬러·딱딱한 벡터 윤곽·강한 디지털 광택은 피하세요.',
        en: 'poetic East Asian sumi-e ink-wash style with nuanced ink gradation, expressive brush pressure, wet blooming, translucent light color washes, and generous negative space. Keep it restrained yet alive, avoiding neon color, rigid vector edges, or strong digital gloss.'
      ...
      // 4. 니트 자수/패브릭 패치풍
      '니트 자수/패브릭 패치풍': {
        ko: '도톰한 자수 실밥의 엠보싱과 실의 방향, 포근한 펠트·패브릭 섬유결, 가장자리 오버록 스티치가 실제로 만져질 듯한 핸드메이드 와펜 스타일. 평면 프린트처럼 보이지 않도록 실의 높낮이와 소재의 폭신함을 살리되 과도한 플라스틱 광택은 피하세요.',
        en: 'handcrafted embroidered patch style with raised thread relief, visible stitch direction, soft felt and fabric fibers, and tactile overlock edging. Preserve plush material depth rather than flat print appearance, and avoid excessive plastic gloss.'
      },
      'Embroidered Patch & Fabric Knit Style': {
        ko: '도톰한 자수 실밥의 엠보싱과 실의 방향, 포근한 펠트·패브릭 섬유결, 가장자리 오버록 스티치가 실제로 만져질 듯한 핸드메이드 와펜 스타일. 평면 프린트처럼 보이지 않도록 실의 높낮이와 소재의 폭신함을 살리되 과도한 플라스틱 광택은 피하세요.',
        en: 'handcrafted embroidered patch style with raised thread relief, visible stitch direction, soft felt and fabric fibers, and tactile overlock edging. Preserve plush material depth rather than flat print appearance, and avoid excessive plastic gloss.'
      ...
      // 5. 빈티지 목판화/실크스크린풍
      '빈티지 목판화/실크스크린풍': {
        ko: '나무판을 새겨 찍은 듯한 요철감과 거친 종이결, 제한된 레트로 색상, 살짝 어긋난 잉크 레이어가 살아있는 빈티지 목판화·실크스크린 스타일. 인쇄 오차와 잉크 번짐을 자연스럽게 남겨 아날로그 깊이를 만들고 지나치게 깨끗한 벡터 마감은 피하세요.',
        en: 'vintage woodblock and silkscreen print style with carved relief texture, grainy paper, a limited retro palette, and subtly misregistered ink layers. Preserve natural print imperfections and ink bleed, avoiding an overly clean digital-vector finish.'
      },
      'Vintage Woodblock & Silkscreen Print Style': {
        ko: '나무판을 새겨 찍은 듯한 요철감과 거친 종이결, 제한된 레트로 색상, 살짝 어긋난 잉크 레이어가 살아있는 빈티지 목판화·실크스크린 스타일. 인쇄 오차와 잉크 번짐을 자연스럽게 남겨 아날로그 깊이를 만들고 지나치게 깨끗한 벡터 마감은 피하세요.',
        en: 'vintage woodblock and silkscreen print style with carved relief texture, grainy paper, a limited retro palette, and subtly misregistered ink layers. Preserve natural print imperfections and ink bleed, avoiding an overly clean digital-vector finish.'
      ...
      // 6. 3D 젤리/글래스 입체풍
      '3D 젤리/글래스 입체풍': {
        ko: '말랑한 젤리와 유리구슬 같은 반투명 재질, 내부 반사와 빛 굴절, 맑은 클리어 코팅 하이라이트가 돋보이는 모던 3D 글래스모피즘 스타일. 탱글한 볼륨과 부드러운 스튜디오 조명을 유지하고, 평면 셀 채색이나 탁한 무광 재질로 바꾸지 마세요.',
        en: 'modern glossy 3D jelly and glassmorphism style with translucent gummy material, internal reflections, luminous refraction, and clear coated highlights. Keep the volume squishy under soft studio lighting, avoiding flat cel shading or dull matte surfaces.'
      },
      'Glossy 3D Jelly & Glassmorphism Style': {
        ko: '말랑한 젤리와 유리구슬 같은 반투명 재질, 내부 반사와 빛 굴절, 맑은 클리어 코팅 하이라이트가 돋보이는 모던 3D 글래스모피즘 스타일. 탱글한 볼륨과 부드러운 스튜디오 조명을 유지하고, 평면 셀 채색이나 탁한 무광 재질로 바꾸지 마세요.',
        en: 'modern glossy 3D jelly and glassmorphism style with translucent gummy material, internal reflections, luminous refraction, and clear coated highlights. Keep the volume squishy under soft studio lighting, avoiding flat cel shading or dull matte surfaces.'
      ...
      // 7. 심플 원라인/볼펜 드로잉풍
      '심플 원라인/볼펜 드로잉풍': {
        ko: '최소한의 단색 볼펜 선과 연속적인 컨투어로 형태를 잡는 심플 원라인 드로잉 스타일. 얇고 자연스러운 선의 리듬과 여백으로 표정과 동작을 전달하고, 과도한 채색·굵은 카툰 외곽선·입체 음영을 배제해 세련된 스케치 감성을 유지하세요.',
        en: 'minimal single-line ballpoint drawing style built from thin natural continuous contours and expressive negative space. Convey pose and emotion through line rhythm, avoiding heavy coloring, thick cartoon borders, or volumetric shading.'
      },
      'Minimalist Single-Line Ballpen Drawing Style': {
        ko: '최소한의 단색 볼펜 선과 연속적인 컨투어로 형태를 잡는 심플 원라인 드로잉 스타일. 얇고 자연스러운 선의 리듬과 여백으로 표정과 동작을 전달하고, 과도한 채색·굵은 카툰 외곽선·입체 음영을 배제해 세련된 스케치 감성을 유지하세요.',
        en: 'minimal single-line ballpoint drawing style built from thin natural continuous contours and expressive negative space. Convey pose and emotion through line rhythm, avoiding heavy coloring, thick cartoon borders, or volumetric shading.'
      ...
      '동글동글 모찌/찹쌀떡 플랫풍': {
        ko: '쫀득한 찹쌀떡처럼 둥글고 통통한 실루엣과 극도로 단순한 얼굴 요소가 중심인 모찌 플랫 스타일. 따뜻한 파스텔 플랫컬러와 최소한의 음영으로 말랑함을 표현하고, 복잡한 디테일이나 사실적인 재질 표현은 줄이세요.',
        en: 'ultra-simple mochi flat style with plump rounded silhouettes and minimal facial features. Use warm pastel flat color with only subtle shading to suggest softness, avoiding busy detail or realistic material rendering.'
      },
      'Round Mochi & Flat Minimal Style': {
        ko: '쫀득한 찹쌀떡처럼 둥글고 통통한 실루엣과 극도로 단순한 얼굴 요소가 중심인 모찌 플랫 스타일. 따뜻한 파스텔 플랫컬러와 최소한의 음영으로 말랑함을 표현하고, 복잡한 디테일이나 사실적인 재질 표현은 줄이세요.',
        en: 'ultra-simple mochi flat style with plump rounded silhouettes and minimal facial features. Use warm pastel flat color with only subtle shading to suggest softness, avoiding busy detail or realistic material rendering.'
      ...
      '키치 & 하이틴 Y2K 스티커풍': {
        ko: '하이틴 다꾸 감성과 키치한 비비드 컬러, 하트·리본·별·글리터 같은 장식이 어우러진 Y2K 스티커 스타일. 꾸민 느낌은 분명하게 살리되 캐릭터 실루엣과 얼굴은 선명하게 유지하고, 장식이 표정이나 주요 형태를 가리지 않게 하세요.',
        en: 'kitsch high-teen Y2K sticker style with vivid color, scrapbook energy, hearts, ribbons, stars, and glitter accents. Keep the decoration bold while preserving a clear character silhouette and unobstructed facial expression.'
      },
      'Kitsch & Y2K High-Teen Sticker Style': {
        ko: '하이틴 다꾸 감성과 키치한 비비드 컬러, 하트·리본·별·글리터 같은 장식이 어우러진 Y2K 스티커 스타일. 꾸민 느낌은 분명하게 살리되 캐릭터 실루엣과 얼굴은 선명하게 유지하고, 장식이 표정이나 주요 형태를 가리지 않게 하세요.',
        en: 'kitsch high-teen Y2K sticker style with vivid color, scrapbook energy, hearts, ribbons, stars, and glitter accents. Keep the decoration bold while preserving a clear character silhouette and unobstructed facial expression.'
      ...
      '맑은 눈의 개그 짤방풍': {
        ko: '해맑고 멍한 눈빛과 묘하게 진지한 표정, 황당한 상황의 대비가 웃음을 만드는 개그 짤방 스타일. 살짝 거친 손그림 선과 단순한 형태를 유지하면서 눈·입·자세의 미세한 어긋남을 과장해 기억에 남는 병맛 포인트를 만드세요.',
        en: 'comedic derp-meme style with innocent blank eyes, oddly serious facial acting, and absurd situational contrast. Use slightly rough handmade lines and simple forms, exaggerating subtle misalignment in eyes, mouth, and pose for memorable humor.'
      },
      'Hilarious Meme & Derp Comedy Style': {
        ko: '해맑고 멍한 눈빛과 묘하게 진지한 표정, 황당한 상황의 대비가 웃음을 만드는 개그 짤방 스타일. 살짝 거친 손그림 선과 단순한 형태를 유지하면서 눈·입·자세의 미세한 어긋남을 과장해 기억에 남는 병맛 포인트를 만드세요.',
        en: 'comedic derp-meme style with innocent blank eyes, oddly serious facial acting, and absurd situational contrast. Use slightly rough handmade lines and simple forms, exaggerating subtle misalignment in eyes, mouth, and pose for memorable humor.'
      ...
      '연필/흑연 감성 드로잉풍': {
        ko: '종이 위에 흑연 연필로 천천히 스케치한 듯한 감성 드로잉 스타일. 부드러운 선, 해칭과 문질러진 명암, 종이결과 연필가루의 미세한 질감을 살려 조용하고 서정적인 분위기를 만들고, 강한 채도나 유광 디지털 마감은 피하세요.',
        en: 'emotional graphite-pencil drawing style with soft sketch lines, hatching, gently smudged shading, visible paper tooth, and subtle graphite dust. Keep the mood quiet and lyrical, avoiding saturated color or glossy digital finishing.'
      },
      'Soft Graphite Pencil Sketch Style': {
        ko: '종이 위에 흑연 연필로 천천히 스케치한 듯한 감성 드로잉 스타일. 부드러운 선, 해칭과 문질러진 명암, 종이결과 연필가루의 미세한 질감을 살려 조용하고 서정적인 분위기를 만들고, 강한 채도나 유광 디지털 마감은 피하세요.',
        en: 'emotional graphite-pencil drawing style with soft sketch lines, hatching, gently smudged shading, visible paper tooth, and subtle graphite dust. Keep the mood quiet and lyrical, avoiding saturated color or glossy digital finishing.'
      ...
      'Oriental Sumi-e Ink Wash Painting': {
        ko: '전통 한지의 여백 위에 먹선의 농담과 붓터치 강약, 은은한 담채 물감의 투명한 번짐을 살린 수묵담채·동양화 스타일. 절제된 색과 자연스러운 발묵을 유지하고 딱딱한 벡터선이나 현대적인 플라스틱 광택은 피하세요.',
        en: 'traditional East Asian ink-wash painting with nuanced brush pressure, transparent light watercolor bleeding, and harmonious negative space on paper. Preserve restrained color and organic ink bloom, avoiding rigid vector edges or modern plastic gloss.'
      },
      '부드러운 수채화풍': {
        ko: '맑고 투명한 수채 워시와 자연스러운 물 번짐, 종이에 스며든 안료의 부드러운 경계가 돋보이는 프리미엄 수채화 스타일. 공기감 있는 파스텔 색과 여백을 살리고, 불투명한 셀 채색이나 날카로운 벡터 윤곽은 피하세요.',
        en: 'premium transparent watercolor style with natural wet washes, softly bleeding pigment edges, and paper-absorbed color. Preserve airy pastel atmosphere and breathing room, avoiding opaque cel fills or rigid vector contours.'
      },
      'Soft watercolor': {
        ko: '맑고 투명한 수채 워시와 자연스러운 물 번짐, 종이에 스며든 안료의 부드러운 경계가 돋보이는 프리미엄 수채화 스타일. 공기감 있는 파스텔 색과 여백을 살리고, 불투명한 셀 채색이나 날카로운 벡터 윤곽은 피하세요.',
        en: 'premium transparent watercolor style with natural wet washes, softly bleeding pigment edges, and paper-absorbed color. Preserve airy pastel atmosphere and breathing room, avoiding opaque cel fills or rigid vector contours.'
      ...
      '색연필 동화책풍': {
        ko: '종이결 위에 색연필을 여러 방향으로 겹쳐 칠한 듯한 따뜻한 동화책 삽화 스타일. 연필 결, 미세한 빈 종이 틈과 부드러운 색 겹침을 살려 포근한 아날로그 감성을 만들고, 매끈한 디지털 그라데이션은 피하세요.',
        en: 'warm colored-pencil storybook style with layered directional strokes over visible paper tooth. Preserve tiny paper gaps and soft color buildup for a cozy analog feel, avoiding perfectly smooth digital gradients.'
      },
      'Colored pencil storybook': {
        ko: '종이결 위에 색연필을 여러 방향으로 겹쳐 칠한 듯한 따뜻한 동화책 삽화 스타일. 연필 결, 미세한 빈 종이 틈과 부드러운 색 겹침을 살려 포근한 아날로그 감성을 만들고, 매끈한 디지털 그라데이션은 피하세요.',
        en: 'warm colored-pencil storybook style with layered directional strokes over visible paper tooth. Preserve tiny paper gaps and soft color buildup for a cozy analog feel, avoiding perfectly smooth digital gradients.'
      ...
      '레트로 애니메이션풍': {
        ko: '80~90년대 셀 애니메이션의 또렷한 외곽선과 단순한 명암 단계, 따뜻하고 살짝 바랜 복고 색감이 살아있는 레트로 애니메이션 스타일. 필름의 은은한 색 번짐과 향수를 살리되 현대적인 3D 볼륨 렌더링은 피하세요.',
        en: 'retro 80s-90s cel-animation style with crisp outlines, simple stepped shading, warm slightly faded color, and subtle film-like bloom. Preserve nostalgic flat animation character and avoid modern volumetric 3D rendering.'
      },
      'Retro animation': {
        ko: '80~90년대 셀 애니메이션의 또렷한 외곽선과 단순한 명암 단계, 따뜻하고 살짝 바랜 복고 색감이 살아있는 레트로 애니메이션 스타일. 필름의 은은한 색 번짐과 향수를 살리되 현대적인 3D 볼륨 렌더링은 피하세요.',
        en: 'retro 80s-90s cel-animation style with crisp outlines, simple stepped shading, warm slightly faded color, and subtle film-like bloom. Preserve nostalgic flat animation character and avoid modern volumetric 3D rendering.'
      ...
      '깔끔한 미니멀 벡터': {
        ko: '군더더기 없는 기하학적 형태와 매끈한 곡선, 제한된 색 팔레트와 정확한 플랫컬러 면 분할이 특징인 미니멀 벡터 스타일. 아이콘처럼 명확한 실루엣과 균형을 우선하고 종이 질감·거친 붓질·복잡한 입체 음영은 제외하세요.',
        en: 'ultra-clean minimal vector style with simple geometry, smooth curves, restrained palette, and precise flat color blocking. Prioritize icon-like silhouette clarity and balance, avoiding paper grain, rough brushwork, or complex volumetric shading.'
      },
      'Clean minimal vector': {
        ko: '군더더기 없는 기하학적 형태와 매끈한 곡선, 제한된 색 팔레트와 정확한 플랫컬러 면 분할이 특징인 미니멀 벡터 스타일. 아이콘처럼 명확한 실루엣과 균형을 우선하고 종이 질감·거친 붓질·복잡한 입체 음영은 제외하세요.',
        en: 'ultra-clean minimal vector style with simple geometry, smooth curves, restrained palette, and precise flat color blocking. Prioritize icon-like silhouette clarity and balance, avoiding paper grain, rough brushwork, or complex volumetric shading.'
      ...
      '통통 튀는 팝아트풍': {
        ko: '강렬한 원색 대비와 굵은 그래픽 외곽선, 대담한 컬러 블록과 인쇄 패턴이 돋보이는 팝아트 스타일. 표정과 동작을 과장해 경쾌한 에너지를 만들고, 자연주의적 색감이나 부드러운 회화 번짐은 피하세요.',
        en: 'vibrant pop-art style with strong primary-color contrast, bold graphic outlines, large color blocks, and print-inspired patterning. Exaggerate expression and gesture for energetic impact, avoiding naturalistic color or soft painterly blending.'
      },
      'Vibrant pop art': {
        ko: '강렬한 원색 대비와 굵은 그래픽 외곽선, 대담한 컬러 블록과 인쇄 패턴이 돋보이는 팝아트 스타일. 표정과 동작을 과장해 경쾌한 에너지를 만들고, 자연주의적 색감이나 부드러운 회화 번짐은 피하세요.',
        en: 'vibrant pop-art style with strong primary-color contrast, bold graphic outlines, large color blocks, and print-inspired patterning. Exaggerate expression and gesture for energetic impact, avoiding naturalistic color or soft painterly blending.'
      ...
      '굵은 선의 코믹북풍': {
        ko: '굵고 강한 검정 잉크선과 극적인 그림자 면, 역동적인 해칭과 그래픽 대비가 특징인 클래식 코믹북 스타일. 캐릭터를 표지 일러스트처럼 강하게 세우고, 부드러운 수채 번짐이나 가벼운 파스텔 톤은 피하세요.',
        en: 'classic comic-book style with heavy black ink line weight, dramatic shadow shapes, dynamic hatching, and bold graphic contrast. Give the character cover-like presence and avoid soft watercolor bleeding or delicate pastel treatment.'
      },
      'Bold line comic book': {
        ko: '굵고 강한 검정 잉크선과 극적인 그림자 면, 역동적인 해칭과 그래픽 대비가 특징인 클래식 코믹북 스타일. 캐릭터를 표지 일러스트처럼 강하게 세우고, 부드러운 수채 번짐이나 가벼운 파스텔 톤은 피하세요.',
        en: 'classic comic-book style with heavy black ink line weight, dramatic shadow shapes, dynamic hatching, and bold graphic contrast. Give the character cover-like presence and avoid soft watercolor bleeding or delicate pastel treatment.'
      ...
      '도트 픽셀 아트풍': {
        ko: '픽셀 그리드가 선명하게 보이는 16비트 레트로 게임 픽셀 아트 스타일. 제한된 팔레트와 계단식 윤곽, 도트 단위 명암으로 형태를 구성하고, 안티에일리어싱 블러나 매끈한 벡터 곡선은 사용하지 마세요.',
        en: 'crisp 16-bit retro pixel-art style with visible pixel grid, limited palette, stepped contours, and pixel-level shading. Do not use anti-aliased blur or smooth vector curves.'
      },
      'Pixel art retro dot': {
        ko: '픽셀 그리드가 선명하게 보이는 16비트 레트로 게임 픽셀 아트 스타일. 제한된 팔레트와 계단식 윤곽, 도트 단위 명암으로 형태를 구성하고, 안티에일리어싱 블러나 매끈한 벡터 곡선은 사용하지 마세요.',
        en: 'crisp 16-bit retro pixel-art style with visible pixel grid, limited palette, stepped contours, and pixel-level shading. Do not use anti-aliased blur or smooth vector curves.'
      ...
      '종이 콜라주풍': {
        ko: '질감 있는 색종이를 손으로 오려 겹쳐 붙인 듯한 페이퍼 컷 콜라주 스타일. 불규칙한 절단 가장자리, 종이 섬유결과 층 사이의 얕은 그림자를 살려 수공예 입체감을 만들고, 플라스틱 재질이나 매끈한 벡터 표면은 피하세요.',
        en: 'hand-cut paper collage style with layered textured paper, slightly irregular cut edges, visible fibers, and shallow shadows between layers. Preserve handmade depth while avoiding plastic material or overly smooth vector surfaces.'
      },
      'Paper collage style': {
        ko: '질감 있는 색종이를 손으로 오려 겹쳐 붙인 듯한 페이퍼 컷 콜라주 스타일. 불규칙한 절단 가장자리, 종이 섬유결과 층 사이의 얕은 그림자를 살려 수공예 입체감을 만들고, 플라스틱 재질이나 매끈한 벡터 표면은 피하세요.',
        en: 'hand-cut paper collage style with layered textured paper, slightly irregular cut edges, visible fibers, and shallow shadows between layers. Preserve handmade depth while avoiding plastic material or overly smooth vector surfaces.'
      ...
      '빈티지 인쇄 만화풍': {
        ko: '오래된 신문과 잡지 인쇄를 연상시키는 하프톤 망점, 거친 잉크 번짐, 살짝 어긋난 오프셋 색과 바랜 종이 질감이 살아있는 빈티지 인쇄 만화 스타일. 디지털적으로 완벽한 정렬과 깨끗한 표면은 의도적으로 피하세요.',
        en: 'vintage newsprint comic style with halftone dots, rough ink bleed, slightly misregistered offset color, and aged paper texture. Intentionally avoid perfect digital registration and overly pristine surfaces.'
      },
      'Vintage print comic': {
        ko: '오래된 신문과 잡지 인쇄를 연상시키는 하프톤 망점, 거친 잉크 번짐, 살짝 어긋난 오프셋 색과 바랜 종이 질감이 살아있는 빈티지 인쇄 만화 스타일. 디지털적으로 완벽한 정렬과 깨끗한 표면은 의도적으로 피하세요.',
        en: 'vintage newsprint comic style with halftone dots, rough ink bleed, slightly misregistered offset color, and aged paper texture. Intentionally avoid perfect digital registration and overly pristine surfaces.'
      ...
      '흑백 만화 톤': {
        ko: '정교한 흑백 잉크선과 스크린톤, 해칭으로 볼륨과 감정을 표현하는 출판 만화 톤 스타일. 컬러 없이도 얼굴과 포즈가 명확히 읽히도록 강한 명암 구조를 유지하고 원색 컬러 채색은 사용하지 마세요.',
        en: 'refined monochrome manga style using crisp black ink, screentones, and hatching to describe volume and emotion. Maintain strong tonal structure for readability without color and avoid saturated color fills.'
      },
      'Monochrome manga tone': {
        ko: '정교한 흑백 잉크선과 스크린톤, 해칭으로 볼륨과 감정을 표현하는 출판 만화 톤 스타일. 컬러 없이도 얼굴과 포즈가 명확히 읽히도록 강한 명암 구조를 유지하고 원색 컬러 채색은 사용하지 마세요.',
        en: 'refined monochrome manga style using crisp black ink, screentones, and hatching to describe volume and emotion. Maintain strong tonal structure for readability without color and avoid saturated color fills.'
      ...
      '열혈 배틀 만화풍': {
        ko: '거칠고 에너지 넘치는 먹선, 극적인 앵글과 속도선, 강한 동세와 긴장감이 중심인 열혈 소년만화 배틀 스타일. 표정과 자세를 과감하게 밀어붙이고 정적인 포즈나 부드러운 로맨스 연출은 피하세요.',
        en: 'high-energy shonen battle style with forceful ink strokes, dramatic camera angles, speed lines, and intense motion. Push facial acting and pose boldly, avoiding static staging or soft romantic treatment.'
      },
      'Hot-blooded battle manga': {
        ko: '거칠고 에너지 넘치는 먹선, 극적인 앵글과 속도선, 강한 동세와 긴장감이 중심인 열혈 소년만화 배틀 스타일. 표정과 자세를 과감하게 밀어붙이고 정적인 포즈나 부드러운 로맨스 연출은 피하세요.',
        en: 'high-energy shonen battle style with forceful ink strokes, dramatic camera angles, speed lines, and intense motion. Push facial acting and pose boldly, avoiding static staging or soft romantic treatment.'
      ...
      '샤방샤방 순정만화풍': {
        ko: '섬세한 펜선과 반짝이는 눈동자, 부드러운 홍조와 화사한 하이라이트가 돋보이는 순정만화 스타일. 로맨틱한 꽃·별·반짝이 장식을 은은하게 사용해 설렘을 만들되 얼굴을 과도하게 평균화하거나 정체성을 잃지 않게 하세요.',
        en: 'sparkling shojo-manga style with delicate linework, luminous eyes, soft blush, and bright highlights. Use subtle floral, star, and sparkle accents for romantic charm while avoiding generic face averaging or identity loss.'
      },
      'Sparkling shojo manga': {
        ko: '섬세한 펜선과 반짝이는 눈동자, 부드러운 홍조와 화사한 하이라이트가 돋보이는 순정만화 스타일. 로맨틱한 꽃·별·반짝이 장식을 은은하게 사용해 설렘을 만들되 얼굴을 과도하게 평균화하거나 정체성을 잃지 않게 하세요.',
        en: 'sparkling shojo-manga style with delicate linework, luminous eyes, soft blush, and bright highlights. Use subtle floral, star, and sparkle accents for romantic charm while avoiding generic face averaging or identity loss.'
      ...
      '8090 레트로 애니풍': {
        ko: '80~90년대 시티팝 애니메이션의 선명한 셀 라인과 제한된 명암, 레트로 파스텔·네온 포인트와 은은한 CRT/필름 감성이 어우러진 스타일. 복고적인 평면 애니 질감을 유지하고 현대적인 풀 3D 렌더링은 피하세요.',
        en: '80s-90s city-pop anime style with crisp cel lines, limited shading steps, retro pastel color with selective neon accents, and subtle CRT/film atmosphere. Preserve flat nostalgic animation character rather than modern full 3D rendering.'
      },
      '80s-90s retro anime': {
        ko: '80~90년대 시티팝 애니메이션의 선명한 셀 라인과 제한된 명암, 레트로 파스텔·네온 포인트와 은은한 CRT/필름 감성이 어우러진 스타일. 복고적인 평면 애니 질감을 유지하고 현대적인 풀 3D 렌더링은 피하세요.',
        en: '80s-90s city-pop anime style with crisp cel lines, limited shading steps, retro pastel color with selective neon accents, and subtle CRT/film atmosphere. Preserve flat nostalgic animation character rather than modern full 3D rendering.'
      ...
      '3D 반실사 애니 렌더링': {
        ko: '극장용 애니메이션처럼 매끈하게 정리된 형태와 부드러운 반실사 3D 볼륨, 자연스러운 재질 반응과 영화적인 스튜디오 조명이 어우러진 고품질 3D 캐릭터 렌더링 스타일. 실제 사람처럼 과도하게 사실화하지 말고 친근한 애니메이션 조형을 유지하세요.',
        en: 'high-quality cinematic 3D character-animation style with polished shapes, soft semi-realistic volume, believable material response, and studio-quality lighting. Keep the character warmly stylized rather than pushing into full human photorealism.'
      },
      '3D Semi-realistic anime rendering': {
        ko: '극장용 애니메이션처럼 매끈하게 정리된 형태와 부드러운 반실사 3D 볼륨, 자연스러운 재질 반응과 영화적인 스튜디오 조명이 어우러진 고품질 3D 캐릭터 렌더링 스타일. 실제 사람처럼 과도하게 사실화하지 말고 친근한 애니메이션 조형을 유지하세요.',
        en: 'high-quality cinematic 3D character-animation style with polished shapes, soft semi-realistic volume, believable material response, and studio-quality lighting. Keep the character warmly stylized rather than pushing into full human photorealism.'
      ...
      '일본 출판 만화풍': {
        ko: '정교한 G펜 잉크선과 필압 변화, 촘촘한 스크린톤과 해칭이 살아있는 고품질 일본 출판 만화 스타일. 선의 밀도와 검정 면을 세심하게 조절해 인쇄 만화의 완성도를 유지하고, 디지털 컬러 페인팅으로 덮지 마세요.',
        en: 'authentic Japanese published-manga style with precise G-pen inking, controlled pressure variation, refined screentones, and detailed hatching. Carefully balance line density and solid blacks, avoiding painted digital color that obscures the print-manga character.'
      },
      'Japanese Manga Ink & Tone Style': {
        ko: '정교한 G펜 잉크선과 필압 변화, 촘촘한 스크린톤과 해칭이 살아있는 고품질 일본 출판 만화 스타일. 선의 밀도와 검정 면을 세심하게 조절해 인쇄 만화의 완성도를 유지하고, 디지털 컬러 페인팅으로 덮지 마세요.',
        en: 'authentic Japanese published-manga style with precise G-pen inking, controlled pressure variation, refined screentones, and detailed hatching. Carefully balance line density and solid blacks, avoiding painted digital color that obscures the print-manga character.'
      ...
      '3D 펠트/클레이 점토 인형풍': {
        ko: '포근한 양모 펠트와 말랑한 클레이를 손으로 빚은 듯한 스톱모션 미니어처 인형 스타일. 펠트 섬유결, 미세한 눌림과 손자국, 부드러운 매크로 스튜디오 조명을 살려 수공예 입체감을 강조하고, 평면 벡터나 지나치게 매끈한 플라스틱 표면은 피하세요.',
        en: 'handcrafted 3D felt-and-claymation miniature style with visible felt fibers, subtle dents and handmade impressions, and soft macro studio lighting. Emphasize tactile stop-motion dimensionality while avoiding flat vector treatment or overly smooth plastic surfaces.'
      },
      '3D Felt & Claymation Doll Style': {
        ko: '포근한 양모 펠트와 말랑한 클레이를 손으로 빚은 듯한 스톱모션 미니어처 인형 스타일. 펠트 섬유결, 미세한 눌림과 손자국, 부드러운 매크로 스튜디오 조명을 살려 수공예 입체감을 강조하고, 평면 벡터나 지나치게 매끈한 플라스틱 표면은 피하세요.',
        en: 'handcrafted 3D felt-and-claymation miniature style with visible felt fibers, subtle dents and handmade impressions, and soft macro studio lighting. Emphasize tactile stop-motion dimensionality while avoiding flat vector treatment or overly smooth plastic surfaces.'
      ...
      '크레파스 낙서풍': {
        ko: '유아 그림책처럼 자유로운 크레파스 선과 왁스 입자, 종이 위에 덧칠한 흔적이 살아있는 손그림 낙서 스타일. 따뜻하고 밝은 색을 사용하고 가장자리의 거친 손맛을 남기며, 매끈한 디지털 벡터나 기계적인 그라데이션은 피하세요.',
        en: 'playful children’s-book crayon doodle style with waxy pigment grain, freehand strokes, and visible layered marks on paper. Use warm bright color, preserve rough handmade edges, and avoid sterile vector smoothness or mechanical gradients.'
      },
      'Crayon Wax Pastel Doodle Style': {
        ko: '유아 그림책처럼 자유로운 크레파스 선과 왁스 입자, 종이 위에 덧칠한 흔적이 살아있는 손그림 낙서 스타일. 따뜻하고 밝은 색을 사용하고 가장자리의 거친 손맛을 남기며, 매끈한 디지털 벡터나 기계적인 그라데이션은 피하세요.',
        en: 'playful children’s-book crayon doodle style with waxy pigment grain, freehand strokes, and visible layered marks on paper. Use warm bright color, preserve rough handmade edges, and avoid sterile vector smoothness or mechanical gradients.'
      ...
      'Y2K 픽셀 스티커풍': {
        ko: '2000년대 Y2K 다꾸 감성의 레트로 픽셀, 글리터, 하트와 별, 메탈릭·젤리 하이라이트가 어우러진 스티커 스타일. 장식은 화려하게 사용하되 캐릭터 실루엣과 표정은 선명하게 남기고, 완전한 실사 재질로 변하지 않게 하세요.',
        en: 'Y2K scrapbook sticker style combining retro pixels, glitter, hearts, stars, and metallic or jelly-like highlights. Keep decoration flashy while preserving a crisp character silhouette and readable expression, without turning the whole image photorealistic.'
      },
      'Y2K Retro Glitter Pixel Sticker Style': {
        ko: '2000년대 Y2K 다꾸 감성의 레트로 픽셀, 글리터, 하트와 별, 메탈릭·젤리 하이라이트가 어우러진 스티커 스타일. 장식은 화려하게 사용하되 캐릭터 실루엣과 표정은 선명하게 남기고, 완전한 실사 재질로 변하지 않게 하세요.',
        en: 'Y2K scrapbook sticker style combining retro pixels, glitter, hearts, stars, and metallic or jelly-like highlights. Keep decoration flashy while preserving a crisp character silhouette and readable expression, without turning the whole image photorealistic.'
  ...
  const getAdaptiveStyleDirectives = (styleTag, promptLang = lang) => {
    ...
    // Selected but otherwise unclassified style: stay medium-neutral and obey the expanded style.
    if (styleTag) {
      return {
  ...
  const getSmartAnthropomorphicInstruction = (subjectText, promptLang = lang) => {
    ...
    const isAnimalOrCreature = /(고양이|냥|강아지|댕댕|개|곰|토끼|원숭이|햄스터|다람쥐|여우|쿼카|판다|고슴도치|알파카|돼지|늘보|코끼리|코기|비숑|리트리버|호랑이|사자|새|뱁새|앵무새|참새|펭귄|오리|문어|오징어|물고기|고래|상어|돌고래|해파리|꽃게|거북|수달|물개|해마|곤충|나비|벌|무당벌레|풍뎅이|사마귀|우파루파|도마뱀|개구리|악어|공룡|티라노|비버|친칠라|해달|미어캣|시츄|말티푸|벨로키랍토르|검치호|모사사우루스|스피노|디플로도쿠스|게코|cat|dog|bear|rabbit|hamster|fox|panda|duck|penguin|octopus|fish|whale|shark|seal|bee|dino|beaver|chinchilla|otter|meerkat|velociraptor|gecko)/i.test(text);
      ...
      appearance: [
        ...(characterSource === 'photo'
          ...
          : [isKo
              ...
              : 'start from a friendly mascot silhouette, while final body proportions and form are determined by the selected art style and selected tags']),
        ...appearances,
      ].join(', ') || (isKo ? '선택 화풍에 맞는 명확하고 일관된 캐릭터 실루엣 유지' : 'maintain a clear and consistent character silhouette appropriate to the selected art style'),
      personality: personalities.join(', ') || (isKo ? '친근하고 표정이 풍부한' : 'friendly and expressive'),
      outfit: outfits.join(', ') || (characterSource === 'photo'
...
- Immediately before rendering, compare every visible syllable against the immutable source phrase and the glyph-lock data. Render each phrase exactly once.`;
  ...
  const generateGptPrompt = (phraseOverride = null) => {
    ...
    const artDirection = expandedArtStyle
      ...
      : getGeminiStyleTags(lang === 'ko' ? 'ko' : 'en');
...
[제외 조건]
${textExclusion} 워터마크, 프레임, 중복 캐릭터, 추가 팔다리, 잘린 신체, 복잡한 풍경과 실사 배경 금지.${selectedArtStyle ? (selectedArtStyle.includes('3D') ? '' : ' 3D 텍스처, 3D 렌더링 금지.') : (characterSource === 'photo' ? '' : ' 3D 텍스처, 3D 렌더링 금지.')}`;
      } else {
        const textPolicy = gptTextMode === 'text'
...
[EXCLUDE]
${textExclusion} No watermark, frame, duplicate character, extra limbs, cropped body, complex scenery, or photorealistic background.${selectedArtStyle ? (selectedArtStyle.includes('3D') ? '' : ' No 3D textures, realistic shading, or glossy gradients.') : (characterSource === 'photo' ? '' : ' No 3D textures, realistic shading, or glossy gradients.')}`;
      }
    }
...
${textExclusionEn}${styleDirectives.negativeExtra ? ` ${styleDirectives.negativeExtra}` : ''}`;
  ...
  const generateGrokPrompt = (phraseOverride = null) => {
    ...
    const selectedArtStyleTag = getSelectedArtStyle();
    const selectedArtStyle = getExpandedArtStyleText(selectedArtStyleTag, false) || selectedArtStyleTag || (characterSource === 'photo' ? 'high-quality character sticker rendering chosen to preserve the uploaded reference identity; do not force 2D or 3D when no art style is selected' : 'Realistic semi-caricature 2D illustration');
    const hasPhraseOverride = phraseOverride !== null;
    const targetPhrase = generationMode === 'individual'
      ? getSelectedPhrase()
      : (phraseOverride || '').trim();
              ...
              <div className="mt-3 bg-mint-soft border border-mint-border rounded-md p-3 sm:p-3.5 flex items-start gap-2.5 text-[13px] text-mint-strong">
                ...
                <div className="leading-relaxed">
                  ...
                  <p className="mt-0.5 opacity-95">
                    {lang === 'ko' 
                      ? '설정을 비워두면 AI가 기본 오리지널 캐릭터를 자동으로 구성합니다. 선택한 화풍이 우선 적용되며, 화풍을 선택하지 않은 경우에만 기본 2D 스타일로 생성됩니다.' 
                      : lang === 'ja'
                      ? '設定を空欄にするとAIが基本のオリジナルキャラクターを自動構成します。選択した画風を優先し、画風を選択していない場合のみ基本2Dスタイルを使用します。'
                      : lang === 'zh'
                      ? '若留空，AI会自动构建默认原创角色。已选择的画风优先；仅在未选择画风时使用默认2D风格。'
                      : 'Leaving this empty lets AI build a default original character. Your selected art style takes priority; the default 2D style is used only when no art style is selected.'}
                  </p>
                </div>
              </div>
            )}
            ...
            >
              <span className="flex items-center justify-between gap-3">
                <span className="min-w-0">
                  ...
                  <strong className="block truncate text-[14px] sm:text-[15.5px] font-semibold text-[#133E32] tracking-tight">
