  ...
  const getExpandedArtStyleText = (styleTag, isKo) => {
    const styleMap = {
      ...
      '동글동글 모찌/찹쌀떡 플랫풍': {
        ...
        en: 'ultra-simplified squishy soft round mochi character style with smooth clean outlines, warm pastel flat colors, and minimal facial features'
      },
      'Round Mochi & Flat Minimal Style': {
        ko: '극도로 단순화된 부드러운 형태와 말랑말랑한 찹쌀떡 질감, 파스텔톤 플랫 채색이 돋보이는 카카오톡 1위 모찌 캐릭터 스타일',
        en: 'ultra-simplified squishy soft round mochi character style with smooth clean outlines, warm pastel flat colors, and minimal facial features'
      ...
      '키치 & 하이틴 Y2K 스티커풍': {
        ko: '선명하고 톡톡 튀는 비비드 네온 컬러와 키치한 레트로 하이틴 스티커 감성이 가득한 트렌디 Y2K 팝 스타일',
        en: 'vibrant kitsch Y2K teen aesthetic sticker illustration with bold vivid colors, sparkling pop accents, and playful retro mood'
      },
      'Kitsch & Y2K High-Teen Sticker Style': {
        ko: '선명하고 톡톡 튀는 비비드 네온 컬러와 키치한 레트로 하이틴 스티커 감성이 가득한 트렌디 Y2K 팝 스타일',
        en: 'vibrant kitsch Y2K teen aesthetic sticker illustration with bold vivid colors, sparkling pop accents, and playful retro mood'
      ...
      '맑은 눈의 개그 짤방풍': {
        ko: '살짝 삐뚤빼뚤한 손그림 느낌의 선과 순수해서 더 킹받는 광기의 표정이 살아있는 코믹 개그 짤방 스타일',
        en: 'hilarious derp meme sticker style with quirky slightly unpolished hand-drawn linework, bright manic wide-eyed comedic expressions, and funny humor'
      },
      'Hilarious Meme & Derp Comedy Style': {
        ko: '살짝 삐뚤빼뚤한 손그림 느낌의 선과 순수해서 더 킹받는 광기의 표정이 살아있는 코믹 개그 짤방 스타일',
        en: 'hilarious derp meme sticker style with quirky slightly unpolished hand-drawn linework, bright manic wide-eyed comedic expressions, and funny humor'
      ...
      '연필/흑연 감성 드로잉풍': {
        ko: '사각사각 연필의 부드러운 흑연 질감과 감성적인 음영 스케치가 어우러진 따뜻한 아날로그 드로잉 스타일',
        en: 'tender analog graphite pencil sketch illustration with textured soft pencil hatching, gentle tonal shading, and cozy handmade feel'
      },
      'Soft Graphite Pencil Sketch Style': {
        ko: '사각사각 연필의 부드러운 흑연 질감과 감성적인 음영 스케치가 어우러진 따뜻한 아날로그 드로잉 스타일',
        en: 'tender analog graphite pencil sketch illustration with textured soft pencil hatching, gentle tonal shading, and cozy handmade feel'
