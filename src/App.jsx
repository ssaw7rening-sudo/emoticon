...
const THEMES_JA = {
  ...
  '株式/資産運用 ①': ['爆上がり行こう！', '救助隊まだ？', '利確完了', '損切りした', '給料秒で消えた', '全財産投資', 'ガチホは勝つ', '元本回収', '塩漬け中', '買い注文完了', '赤ろうそく上昇', '青ろうそく涙', 'ストップ高！', '暴落だ', '口座が溶ける'],
  '株式/資産運用 ②': ['チャート分析中', '種銭貯め中', 'デイトレ成功', 'ガチホ長期投資', '強気相場到来', '弱気相場耐える', 'イナゴ買い禁止', 'メンタル保つ', '利益率マウント', '投資成功', 'タワマン入居', '救助隊搭乗', '相場チェック', '配当金着金', '爆益祈願'],
  'ゲーム/ゲーマー ①': ['あと一戦だけ！', '俺がキャリーする', 'トロール禁止', 'ログイン完了', 'ヘッドセット装着', '昇格戦失敗', '味方ガチャ外れ', 'ゲームする人？', 'ラスト一戦！', '全滅戦', 'ギルド員募集', 'ボスレイド', 'レアドロップ！', 'スキルCT中', 'ゲームオーバー'],
  'ゲーム/ゲーマー ②': ['レベルアップ！', 'クエスト完了', '神プレイング', '操作の天才', '押し間違えた！', '降参しよう', '逆転勝利！', 'ゲーマーの性', 'ゲーム廃人', 'サウンドプレイ', '攻略完璧', '強化成功！', '強化失敗破壊', 'HPゲージ限界', 'GG打った'],
  '健康/疲労 ①': ['慢性疲労', '風邪気味', 'サプリ服用', '腰が痛い', 'ビタミン補給', '病院行ってきた', '今日は休もう', '目がショボショボ', '薬服用中', '体調崩し中', '体力低下', '免疫力低下', 'ストレッチ中', '健康診断', '爆寝しよう'],
  '健康/疲労 ②': ['ウズウズする', '頭痛地獄', '肩こりひどい', 'ストレートネック警告', 'カフェイン補給', '体力回復', '滋養強壮', '風邪ひかないでね', 'インフル予防', 'スッキリした朝', 'むくみ解消', '健康一番', 'ゆっくり休んでね', '運動しよう', 'パワー充填'],
};
...
const THEMES_ZH = {
  ...
  '股票/理财 ①': ['暴涨起飞！', '解套救援队呢？', '止盈落袋', '割肉止损', '工资瞬间蒸发', '押上全部身家', '死扛到底必胜', '本金收回', '被套牢了', '建仓买入', '红盘暴涨！', '绿盘流泪', '涨停板！', '大暴跌', '账户融化中'],
  '股票/理财 ②': ['K线图分析中', '攒本金中', '超短线成功', '长线价值投资', '牛市来了', '熊市硬杠', '禁止追涨杀跌', '稳住心态', '晒收益率', '投资成功', '入住江景房', '登上救援艇', '盘面复盘', '股息到账', '祝您大赚'],
  '游戏/玩家 ①': ['再来一局！', '我带飞全场', '拒绝坑友', '已上线', '戴上耳机', '晋级赛渡劫失败', '匹配到神仙队友', '有人开黑吗？', '最后一局！', '决战到底', '公会招人', 'Boss副本', '爆出神装！', '技能CD中', 'Game Over'],
  '游戏/玩家 ②': ['Level Up 升级！', '任务完成', '神级操作', '拉满控制', '手滑误操作！', '点投降吧', '逆风翻盘！', '网瘾发作', '重度游戏迷', '听声辨位', '通关攻略熟记', '强化成功！', '强化碎了', '血条见底', '打出GG'],
  '健康/疲劳 ①': ['慢性疲劳', '浑身酸痛', '按时吃保健品', '老腰要断了', '补充维生素', '刚看诊回来', '今天休息吧', '眼睛干涩', '按时吃药', '虚弱发病中', '体力透支', '免疫力下降', '拉伸放松', '健康体检', '睡个好觉'],
  '健康/疲劳 ②': ['身上发痒想动', '头痛欲裂', '肩膀酸痛', '颈椎病警告', '续命咖啡', '恢复体力', '大补一顿', '注意保暖防感冒', '预防流感', '神清气爽', '水肿消除', '身体健康最重要', '好好休息', '一起健身', '能量充满'],
};
...
const CHARACTER_TAGS_JA = {
  ...
  '🦄 ファンタジー/モノ': ['ユニコーン', '子ドラゴン', '魔法使い', '森の妖精', 'もちもちモッチ', 'マカロン', '苺ケーキ', '小籠包', '子バンパイア', '人魚姫', '騎士', '宇宙人', '九尾の狐', '小鬼', '天使', '小悪魔', '空飛ぶ魔法の絨毯', '綿菓子雲', 'セイレーン', 'ペガサス', 'おしゃべりカボチャ', '宇宙飛行士', '魔法のほうき', 'ジェリーモンスター', '雪だるま'],
  '🤖 ロボット/SF': ['子ロボット', 'サイバーニャンコ', 'ぷ니ぷ니スライム', '宇宙ハムスター', '子恐竜', 'ドット絵ロボ', 'ちび宇宙人', 'メカ犬', 'ネオンゴースト'],
  '🍞 デザート/フード': ['しゃべる鯛焼き', '食パンおじさん', 'マカロンうさぎ', 'アメリカーノ幽霊', 'ぷっくり餃子っ子', 'いちご大福', 'チョコチップクッキー', 'チーズハットグ', 'ぷるぷるプリン'],
  '🌿 植物/自然': ['サボテンっ子', '四つ葉のクローバー妖精', 'まんまるキノコ', '植木鉢ベイビー', 'ひまわりちゃん', '新芽の妖精', 'もみじっ子', 'プチトマト'],
  ...
  '🖌️ 画風': ['可愛い2Dアニメ風', '韓国ウェブトゥーン風', '手書き落書き風', '柔らかい水彩画風', '色鉛筆絵本風', 'レトロアニメ風', 'クリーンなミニマルベクトル', 'ポップアート風', 'アメコミ風', 'ドット絵ピクセル風', 'ペーパーコラージュ風', 'ヴィンテージ印刷風', '📖 モノクロ漫画トーン', '💥 熱血バトル漫画風', '🌸 少女漫画風', '👾 8090レトロアニメ風', '🎨 3Dアニメレンダリング'],
  ...
  '🌏 世界の文化・伝統': ['伝統的な韓服（ハンボク）', 'モダンなヒップホップ韓服', 'K-POPアイドルステージ衣装', 'テコンドー道着', '伝統的な着物・浴衣', '秋葉原メイドコスプレ', '侍（サムライ）・忍者装束', '日本のセーラー服・学生服', '神社巫女（みこ）装束', '武侠・仙侠のシルク道袍', '華やかなチャイナドレス・漢服', 'カンフー武術家（黄色の道着）', '京劇の仮面役者', '西部劇カウボーイ・保安官', 'ロンドン紳士トレンチコート', 'サイバーパンクネオンストリート', '中世ヨーロッパ騎士の甲冑', 'パリジャンのベレー帽とバゲット', 'イギリス王室近衛兵（毛皮帽子）', 'スペイン情熱のフラメンコダンサー', 'ドイツのオクトーバーフェスト衣装', 'ベネチア仮面舞踏会衣装', 'メキシカンマリアッチ＆ソンブレロ', '死者の日シュガースカル仮装', 'ブラジルサンバカーニバルダンサー', 'ベトナムアオザイ＆ノンラー笠', 'タイ伝統サバイ衣装', 'インド伝統サリー＆ボリウッド', 'アラビ安ナイトのターバン＆魔法のランプ', 'ハワイアンアロハシャツ＆ウクレレ'],
...
const CHARACTER_TAGS_ZH = {
  ...
  '🦄 幻想/物品': ['独角兽', '小龙', '小法师', '森林妖精', '糯米软糬', '马卡龙', '草莓蛋糕', '小笼包', '小吸血鬼', '美人鱼', '勇敢小骑士', '外星人', '九尾狐', '小鬼怪', '天使', '小恶魔', '飞天魔毯', '棉花糖云朵', '赛琳', '佩格萨斯（飞马）', '会说话的南瓜', '宇航员', '扫帚', '果冻怪', '雪人妖精'],
  '🤖 机器人/科幻': ['小机器人', '赛博喵星人', '软糯史莱姆', '太空仓鼠', '小恐龙', '像素机器人', '小外星人', '机械小狗', '霓虹幽灵'],
  '🍞 甜品/美食': ['会说话的鲷鱼烧', '吐司面包大叔', '马卡龙兔子', '美式咖啡幽灵', '胖嘟嘟饺子童子', '草莓大福', '巧克力大福', '芝士热狗', '软糯布丁'],
  '🌿 植物/自然': ['仙人掌宝宝', '四叶草仙子', '圆滚滚蘑菇', '盆栽宝宝', '小向日葵', '嫩芽仙子', '枫叶宝宝', '圣女果'],
  ...
  '🖌️ 画风': ['可爱2D漫画风', '韩国条漫风', '手绘涂鸦风', '柔和水彩风', '色铅笔绘本风', '复古动画风', '极简矢量风', '波普艺术风', '美漫风', '像素风', '剪纸拼贴风', '复古印刷漫画风', '📖 黑白漫画网点风', '💥 热血战斗漫画风', '🌸 少女漫画风', '👾 8090复古动漫风', '🎨 3D半写实动画渲染'],
...
const CHARACTER_TAGS_EN = {
  ...
  '🦄 Fantasy/Object': ['Unicorn', 'Baby Dragon', 'Little Wizard', 'Forest Fairy', 'Soft Mochi', 'Sweet Macaron', 'Strawberry Cake', 'Chubby Dumpling', 'Little Vampire', 'Little Mermaid', 'Brave Little Knight', 'Alien', 'Baby Nine-tailed Fox', 'Cute Goblin', 'Shining Angel', 'Playful Baby Devil', 'Flying Magic Carpet', 'Cotton Candy Cloud', 'Mysterious Mermaid', 'Winged Pegasus', 'Talking Pumpkin', 'Astronaut', 'Magic Broom', 'Jelly Monster', 'Snowman Fairy'],
  '🤖 Robot/Sci-Fi': ['Baby Robot', 'Cyber Cat', 'Squishy Slime', 'Space Hamster', 'Baby Dinosaur', 'Pixel Robot', 'Little Alien', 'Mecha Dog', 'Neon Ghost'],
  '🍞 Dessert/Food': ['Talking Fish Pastry', 'Bread Gentleman', 'Macaron Bunny', 'Americano Ghost', 'Plump Dumpling Kid', 'Strawberry Mochi', 'Choco Chip Cookie', 'Cheese Hot Dog', 'Squishy Pudding'],
  '🌿 Plant/Nature': ['Baby Cactus', 'Four-leaf Clover Fairy', 'Round Mushroom', 'Potted Plant Kid', 'Sunflower Little', 'Sprout Fairy', 'Baby Maple Leaf', 'Cherry Tomato'],
  ...
  '🖌️ Art Style': ['Cute 2D cartoon', 'Korean webtoon style', 'Hand-drawn doodle', 'Soft watercolor', 'Colored-pencil storybook', 'Retro animation', 'Clean minimal vector', 'Vibrant pop art', 'Bold comic-book style', 'Pixel art', 'Paper collage', 'Vintage print cartoon', '📖 Monochrome Manga Screentone', '💥 Shonen Battle Manga', '🌸 Shojo Romance Manga', '👾 Classic 80s Anime', '🎨 3D Semi-realistic Animated Film'],
