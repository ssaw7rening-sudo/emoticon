...
const AdBanner = () => {
  ...
  return (
    <div className="text-center mt-lg md:mt-xl p-4 md:p-md bg-surface-container-lowest rounded-2xl border border-outline-variant shadow-bubbly overflow-hidden">
  ...
  return (
    <section id="guide-section" className="flex flex-col gap-sm mt-xl mb-xl">
      <div className="flex flex-wrap justify-between items-center gap-3 mb-3">
        ...
        {/* 탭 헤더 */}
        <div className="flex items-center gap-1.5 overflow-x-auto no-scrollbar bg-mint-soft p-1.5 rounded-2xl border border-mint-border shadow-xs w-full lg:w-auto flex-nowrap shrink-0">
          <button 
        ...
        {activeTab === 'model' && (
          <div className="animate-in fade-in slide-in-from-bottom-2 duration-300 flex flex-col gap-4 mt-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* ChatGPT Card */}
              <div className="bg-surface-variant/30 p-4 sm:p-5 rounded-2xl border border-outline-variant flex flex-col gap-4 hover:shadow-md transition-shadow group relative">
            ...
            {/* Unified Tip Box */}
            <div className="bg-primary/10 text-primary-strong p-3.5 sm:p-4 rounded-2xl border border-primary/20 mt-2 flex gap-3 items-start shadow-sm">
        ...
        {activeTab === 'bg' && (
          <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
            <div className="flex flex-col gap-5 mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {/* PC Guide */}
                <div className="bg-[#FAF9F6] p-4 sm:p-5 rounded-2xl border border-[#E5E0D8] flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-3 h-full">
                    <div className="bg-white p-4 sm:p-5 rounded-2xl md:rounded-2xl border border-[#E5E0D8] shadow-sm flex-1 flex flex-col">
            ...
            <div className="flex flex-col gap-5 mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-[#FAF9F6] p-4 sm:p-5 rounded-2xl border border-[#E5E0D8] flex flex-col gap-4">
                  ...
                  <div className="bg-white p-4 sm:p-5 rounded-2xl md:rounded-2xl border border-[#E5E0D8] shadow-sm flex-1 flex flex-col gap-3">
                    ...
                    <div className="bg-[#FFF5F5] text-[#D32F2F] p-3.5 sm:p-4 rounded-2xl border border-[#FFCDD2] my-1">
                      <div className="mb-2">
                ...
                <div className="bg-[#FAF9F6] p-4 sm:p-5 rounded-2xl border border-[#E5E0D8] flex flex-col gap-4">
                  ...
                  <div className="bg-white p-4 sm:p-5 rounded-2xl md:rounded-2xl border border-[#E5E0D8] shadow-sm flex-1 flex flex-col gap-3">
                    ...
                    <div className="w-full h-40 rounded-2xl overflow-hidden border border-[#E5E0D8] my-1 shadow-sm relative group">
  ...
  return (
    <div className="font-body-md text-body-md antialiased pb-32 max-w-full w-full">
      ...
      <main className="max-w-3xl mx-auto px-container-margin mt-md md:mt-xl flex flex-col gap-lg md:gap-xl">
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-[#FFD3B6] via-[#FFE8B6] to-[#FFC2C2] text-[#5C3A21] p-4 sm:p-6 md:p-xl rounded-2xl shadow-bubbly text-center flex flex-col items-center justify-center gap-3 sm:gap-4 md:gap-6 border-2 sm:border-4 border-white max-w-full w-full">
        ...
        <section className="flex flex-col sm:flex-row gap-4 mt-sm pb-xl">
          <button 
            ...
            className="interactive-control w-full min-h-[64px] flex-none sm:flex-1 rounded-2xl bg-[#FFE8B5] text-[#5A461B] border border-[#E8C66A] font-headline-sm flex items-center justify-center gap-2 hover:bg-[#FFDB80] shadow-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-[#E8C66A] focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:bg-[#FFE8B5]"
          >
        ...
        <div className="bg-[#FFF5E6] text-[#8C3D18] p-4 sm:p-5 md:p-6 rounded-2xl border border-[#FDE0B5] flex gap-3 md:gap-4 items-start shadow-sm mt-2 relative overflow-hidden">
          ...
          <div className="relative z-10 flex-1 min-w-0">
            ...
            <div className="bg-white/60 rounded-xl sm:rounded-2xl p-3 sm:p-4 border border-[#FCD3A1]/60 shadow-sm flex flex-col gap-1.5 sm:gap-2 w-full">
