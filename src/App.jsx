...
const AdBanner = () => {
  ...
  return (
    <div className="text-center mt-lg md:mt-xl p-4 md:p-md bg-surface-container-lowest rounded-xl border border-outline-variant shadow-bubbly overflow-hidden">
  ...
  return (
    <section id="guide-section" className="flex flex-col gap-sm mt-xl mb-xl">
      <div className="flex flex-wrap justify-between items-center gap-3 mb-3">
        ...
        {/* 탭 헤더 */}
        <div className="flex items-center gap-1.5 overflow-x-auto no-scrollbar bg-mint-soft p-1.5 rounded-xl border border-mint-border shadow-xs w-full lg:w-auto flex-nowrap shrink-0">
          <button 
        ...
        {activeTab === 'model' && (
          <div className="animate-in fade-in slide-in-from-bottom-2 duration-300 flex flex-col gap-4 mt-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* ChatGPT Card */}
              <div className="bg-surface-variant/30 p-4 sm:p-5 rounded-xl border border-outline-variant flex flex-col gap-4 hover:shadow-md transition-shadow group relative">
                ...
                <div className="w-full h-56 rounded-xl bg-white border border-outline-variant shadow-sm relative overflow-hidden group">
            ...
            {/* Unified Tip Box */}
            <div className="bg-primary/10 text-primary-strong p-3.5 sm:p-4 rounded-xl border border-primary/20 mt-2 flex gap-3 items-start shadow-sm">
        ...
        {activeTab === 'bg' && (
          <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
            <div className="flex flex-col gap-5 mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {/* PC Guide */}
                <div className="bg-[#FAF9F6] p-4 sm:p-5 rounded-xl border border-[#E5E0D8] flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-3 h-full">
                    <div className="bg-white p-4 sm:p-5 rounded-xl md:rounded-xl border border-[#E5E0D8] shadow-sm flex-1 flex flex-col">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-6 bg-[#F4F4F4] p-8 rounded-xl border border-[#E5E5E5]">
              
              {/* Step 1 */}
              <div className="flex flex-col items-center gap-3">
                <div className="w-28 h-28 rounded-xl bg-[#00FF00] flex items-center justify-center border-4 border-dashed border-primary shadow-sm relative overflow-hidden group hover:scale-105 transition-transform">
              ...
              {/* Step 2 */}
              <div className="flex flex-col items-center gap-3">
                <div className="w-28 h-28 rounded-xl bg-white flex flex-col items-center justify-center border-2 border-outline-variant shadow-bubbly relative group hover:scale-105 transition-transform">
              ...
              {/* Step 3 */}
              <div className="flex flex-col items-center gap-3">
                <div className="w-28 h-28 rounded-xl flex items-center justify-center border-2 border-outline-variant shadow-sm relative group hover:scale-105 transition-transform" style={{ backgroundImage: 'conic-gradient(#e5e7eb 25%, white 25%, white 50%, #e5e7eb 50%, #e5e7eb 75%, white 75%, white)', backgroundSize: '16px 16px' }}>
            ...
            <div className="flex flex-col gap-5 mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-[#FAF9F6] p-4 sm:p-5 rounded-xl border border-[#E5E0D8] flex flex-col gap-4">
                  ...
                  <div className="bg-white p-4 sm:p-5 rounded-xl md:rounded-xl border border-[#E5E0D8] shadow-sm flex-1 flex flex-col gap-3">
                    ...
                    <div className="bg-[#FFF5F5] text-[#D32F2F] p-3.5 sm:p-4 rounded-xl border border-[#FFCDD2] my-1">
                      <div className="mb-2">
                ...
                <div className="bg-[#FAF9F6] p-4 sm:p-5 rounded-xl border border-[#E5E0D8] flex flex-col gap-4">
                  ...
                  <div className="bg-white p-4 sm:p-5 rounded-xl md:rounded-xl border border-[#E5E0D8] shadow-sm flex-1 flex flex-col gap-3">
                    ...
                    <div className="w-full h-40 rounded-xl overflow-hidden border border-[#E5E0D8] my-1 shadow-sm relative group">
                    ...
                    <div className="mt-auto bg-primary/10 text-primary-strong font-bold text-[13px] p-3 rounded-xl flex items-start gap-2 leading-relaxed">
    ...
    <div className="font-body-md text-body-md antialiased pb-32 max-w-full w-full">
      ...
      <main className="max-w-3xl mx-auto px-container-margin mt-md md:mt-xl flex flex-col gap-lg md:gap-xl">
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-[#FFD3B6] via-[#FFE8B6] to-[#FFC2C2] text-[#5C3A21] p-4 sm:p-6 md:p-xl rounded-xl shadow-bubbly text-center flex flex-col items-center justify-center gap-3 sm:gap-4 md:gap-6 border-2 sm:border-4 border-white max-w-full w-full">
          ...
          <p className="z-10 text-[13px] sm:text-[15px] md:text-[17px] leading-relaxed max-w-2xl mx-auto font-bold bg-white/40 p-3.5 sm:p-5 rounded-xl backdrop-blur-md border border-white/60 shadow-sm whitespace-pre-wrap [word-break:break-word] [overflow-wrap:anywhere] w-full">
            {t.guide1A}
          </p>
        </section>
        ...
        <section className="flex flex-col gap-md">
          ...
          <div className="bg-surface-container-lowest rounded-xl p-3.5 sm:p-md shadow-bubbly border border-outline-variant">
            ...
            <textarea 
              className="w-full bg-white border-2 border-mint-border rounded-xl p-3.5 sm:p-4 text-on-surface font-bold placeholder:text-on-surface-variant focus:outline-none focus:ring-4 focus:ring-mint focus:border-mint-border resize-y min-h-[100px] shadow-sm" 
            ...
            <div className="mt-md bg-surface-container-highest rounded-xl overflow-hidden">
        ...
        <section className="flex flex-col gap-md">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2" role="group" aria-label={lang === 'ko' ? '프롬프트 생성 방식' : 'Prompt generation mode'}>
              {[
                ...
                <button
                  ...
                  className={`interactive-control min-h-12 px-3 py-2 rounded-xl text-[14px] font-bold border focus:outline-none focus-visible:ring-2 focus-visible:ring-[#E8C66A] focus-visible:ring-offset-2 ${
                    generationMode === mode
            ...
            {generationMode === 'individual' && (
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  className="w-full min-h-12 rounded-xl bg-white px-4 text-on-surface font-bold border border-[#E8C66A] focus:outline-none focus:ring-2 focus:ring-[#E8C66A]"
                  ...
                  {emoticons.map((phrase, idx) => {
                    ...
                    return (
                      <button
                        ...
                        className={`interactive-control min-h-11 px-3 py-2 rounded-xl border font-bold flex items-center justify-center gap-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#E8C66A] focus-visible:ring-offset-2 ${
                          isSelected
                            ? 'bg-[#FFE8B5] text-[#5A461B] border-[#E8C66A] shadow-sm'
                            : 'bg-white text-on-surface border-[#E9DFC5] hover:bg-[#FFF3D8]'
                        }`}
          ...
          {visiblePromptValidationError && (
            <p role="alert" className="rounded-xl border border-error/30 bg-[#FFF0F0] px-4 py-3 text-[13px] font-bold text-error">
              {visiblePromptValidationError}
            </p>
          )}
        ...
        <section className="flex flex-col sm:flex-row gap-4 mt-sm pb-xl">
          <button 
            ...
            className="interactive-control w-full min-h-[64px] flex-none sm:flex-1 rounded-xl bg-[#FFE8B5] text-[#5A461B] border border-[#E8C66A] font-headline-sm flex items-center justify-center gap-2 hover:bg-[#FFDB80] shadow-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-[#E8C66A] focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:bg-[#FFE8B5]"
          >
