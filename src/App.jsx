...
const THEMES_KO = {
  ...
  '럭키비키/초긍정 ①': ['오히려 좋아!', '완전 럭키잖아', '럭키비키 니키', '난 역시 행운아', '다 잘될 거야', '행운 충전 완료', '오예 럭키!', '기회는 지금!', '행복 회로 가동', '오늘 운세 대박', '웃으면 복이 와', '오히려 이득!', '꽃길만 걷자', '낭만 합격!', '내일은 더 대박'],
  '럭키비키/초긍정 ②': ['오히려 개이득', '이게 되네?', '내 인생 레전드', '초긍정 파워!', '하늘도 내 편', '별거 아니야 훗', '마음먹기 나름', '우주가 날 도와', '럭키력 상승!', '긍정 빔 발사!', '행복은 셀프', '탈룰라 대성공', '걱정은 털어내', '다 하늘의 뜻', '내일도 럭키!'],
  'K-직장인 생존기 ①': ['넵!', '네... (영혼 가출)', '탕비실 털러 감', '금융치료 시급', '퇴근각 재는 중', '넵 알겠습니다!', '월급 로그아웃', '회의 지옥...', '카페인 수혈 중', '시말서 각인가', '법카 가자!', '살려주세요...', '칼퇴 10초 전', '주말만 봐요', '내일 연차 씀!'],
  ...
  '러닝/마라톤 ①': ['오늘 러닝 끝!', '5km 완주!', '페이스 유지!', '새 신발 개시!', '심장 터짐!', '러닝 크루 모여', '아침 조깅 상쾌', '스트레칭 쭉쭉', '물 원샷 꿀꺽', '최고 기록 경신!', '우중런 감성', '숨 고르는 중', '10km 도전!', '땀 뻘뻘 개운!', '내일도 뛴다!'],
...
const THEMES_EN = {
  ...
  'Lucky Vicky/Ultra Positive ①': ['Even better now!', 'Totally Lucky Vicky', 'Born lucky~', 'All will be fine', 'Lucky recharge', 'Lady luck is here', 'Now is the time!', 'Mindset is key', 'Happiness mode ON', 'Super lucky day', 'Smile brings luck', 'Win-win for me!', 'Flower path only', 'Romantic pass!', 'Tomorrow bigger!'],
  'Lucky Vicky/Ultra Positive ②': ['Huge profit!', 'It actually works?', 'Legendary life', 'Ultra positive!', 'Heavens on my side', 'No big deal haha', 'All in the mind', 'Universe helps me', 'Lucky power UP!', 'Positive beam!', 'Self happiness', 'Saved the day!', 'Shake off worry', 'Destiny at work', 'Lucky tomorrow!'],
  'Office Survival Mode ①': ['Got it!', 'Yes... (drained)', 'Snack bar raid', 'Paycheck therapy', 'Timing clock-out', 'Yes sir, noted!', 'Salary logged out', 'Meeting hell...', 'Caffeine reload', 'Write-up incoming?', 'On company card!', 'Save me please...', '10s to clock-out', 'Living for Friday', 'Taking PTO!'],
  ...
  'Running/Marathon Crew ①': ['Run done today!', 'Finished 5k!', 'Keep the pace!', 'New shoes unboxed!', 'Heart pumping!', 'Run crew assemble', 'Morning jog fresh', 'Stretching legs', 'Chugging water', 'New PB record!', 'Rainy run vibes', 'Catching breath', 'Aiming for 10k!', 'Sweat so clean!', 'Running tomorrow!'],
...
const THEMES_JA = {
  ...
  '超ポジティブ・幸運 ①': ['むしろ最高！', '完全ラッキー！', 'やっぱり持ってる', '全部うまくいく', '幸運チャージ完了', '女神降臨中！', '今がチャンス！', '気持ち次第！', '幸せ回路全開', '今日の運勢最高', '笑う門に福来る', '完全に得した！', '花道だけ歩こう', 'ロマン合格！', '明日はもっと大吉'],
  '超ポジティブ・幸運 ②': ['むしろ大得！', 'これいける？', '我が人生レジェンド', '超ポジティブ！', '天も味方してる', '大したことないサ', '気の持ちよう！', '宇宙が味方！', 'ラッキー度急上昇', 'ポジティブ光線！', '幸せは自分次第', '大逆転セーフ！', '悩み吹き飛ばせ', 'すべて運命！', '明日もラッキー！'],
  'リアル会社員・サバイバル ①': ['承知！', 'はい…（抜け殻）', '給湯室襲撃中', '金銭治療が急務', '退勤チャンス狙い', '了解いたしました', '給料ログアウト', '会議地獄…', 'カフェイン点滴中', '始末書フラグ？', '経費で落とそう', '助けてくれ〜', '定時10秒前！', '週末だけ見てる', '明日有休です！'],
  ...
  'ランニング・マラソン ①': ['今日のラン終了！', '5km完走！', 'ペース維持！', '新シューズ解禁！', '心臓バクバク！', 'ラン仲間集まれ', '朝ジョグ爽快！', 'ストレッチ入念', '水ごくごく補給', '自己ベスト更新！', '雨ランエモい', '息を整え中', '10km挑戦！', '汗かいて快感！', '明日も走るぞ！'],
...
const THEMES_ZH = {
  ...
  '超幸运・积极满满 ①': ['反而更好！', '完全超幸运', '运气爆棚啦', '一切都会好', '电量满格充电', '幸运女神驾到', '机会就是现在', '心态最重要', '快乐回路启动', '今日运势大吉', '笑口常开福到', '反而更划算！', '一路走花路', '浪漫满分！', '明天更精彩'],
  '超幸运・积极满满 ②': ['反而大赚！', '这也能成？', '人生高光时刻', '超正能量！', '老天都在帮我', '小事一桩啦', '看怎么想咯', '宇宙在偏爱我', '好运值狂飙！', '发射正向光波', '快乐掌握自己', '反向操作大胜', '甩掉所有焦虑', '都是最好安排', '明天也超幸运！'],
  '打工人求生日常 ①': ['收到！', '好的…（已枯萎）', '搜刮茶水间去', '急需金钱疗法', '下班倒计时中', '好的马上办！', '工资秒退登出', '开会无底洞…', '咖啡强行续命', '又要写检讨？', '刷公司公账！', '救救孩子吧…', '下班前10秒', '只盼周末活着', '明天休年假啦！'],
  '打工人求生日常 ②': ['收到综合症', '工资卡被路过', '冰美式急救', '方案又被退…', '这已是极限了', '被已读不回？', '逃离会议计划', '带薪洗手间避难', '下班脚底抹油', '今晚吃顿肉？', '对着屏幕发呆', '琢磨请假理由', '想回家了（泪）', '看着余额忍住', '今日成功渡劫！'],
  '跑步・马拉松跑团 ①': ['今日跑步搞定！', '5公里完赛！', '稳住配速！', '新跑鞋开箱！', '心跳狂飙！', '跑团小伙伴集结', '晨跑空气太棒', '拉伸做起来', '大口咕嘟补水', '刷新最佳战绩！', '雨中跑步浪漫', '慢慢调整呼吸', '挑战十公里！', '大汗淋漓爽快！', '明天接着跑！'],
